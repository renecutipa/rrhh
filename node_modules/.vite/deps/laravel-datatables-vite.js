...
var require_jquery = __commonJS({
  "node_modules/jquery/dist/jquery.js"(exports, module) {
    (function(global, factory) {
      ...
      var version = "3.7.1", rhtmlSuffix = /HTML$/i, jQuery8 = function(selector, context) {
        return new jQuery8.fn.init(selector, context);
      };
      jQuery8.fn = jQuery8.prototype = {
        ...
        pushStack: function(elems) {
          var ret = jQuery8.merge(this.constructor(), elems);
          ret.prevObject = this;
          return ret;
        },
        // Execute a callback for every element in the matched set.
        each: function(callback) {
          return jQuery8.each(this, callback);
        },
        map: function(callback) {
          return this.pushStack(jQuery8.map(this, function(elem, i2) {
        ...
        even: function() {
          return this.pushStack(jQuery8.grep(this, function(_elem, i2) {
            return (i2 + 1) % 2;
          }));
        },
        odd: function() {
      ...
      jQuery8.extend = jQuery8.fn.extend = function() {
        ...
        for (; i2 < length; i2++) {
          if ((options = arguments[i2]) != null) {
            for (name in options) {
              ...
              if (deep && copy && (jQuery8.isPlainObject(copy) || (copyIsArray = Array.isArray(copy)))) {
                src = target[name];
                if (copyIsArray && !Array.isArray(src)) {
                  clone = [];
                } else if (!copyIsArray && !jQuery8.isPlainObject(src)) {
                  clone = {};
                } else {
                  clone = src;
                }
                copyIsArray = false;
                target[name] = jQuery8.extend(deep, clone, copy);
              } else if (copy !== void 0) {
                target[name] = copy;
              }
            }
      ...
      if (typeof Symbol === "function") {
        jQuery8.fn[Symbol.iterator] = arr[Symbol.iterator];
      }
      jQuery8.each(
      ...
      jQuery8.escapeSelector = function(sel) {
        return (sel + "").replace(rcssescape, fcssescape);
      };
      var preferredDoc = document2, pushNative = push;
      (function() {
        var i2, Expr, outermostContext, sortInput, hasDuplicate, push2 = pushNative, document3, documentElement2, documentIsHTML, rbuggyQSA, matches, expando = jQuery8.expando, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
          if (a === b) {
            hasDuplicate = true;
          }
          return 0;
                ...
                if (nodeType === 1 && (rdescend.test(selector) || rleadingCombinator.test(selector))) {
                  ...
                  if (newContext != context || !support.scope) {
                    if (nid = context.getAttribute("id")) {
                      nid = jQuery8.escapeSelector(nid);
                    } else {
        ...
        function setDocument(node) {
          ...
          documentIsHTML = !jQuery8.isXMLDoc(document3);
          ...
          support.getById = assert(function(el) {
            documentElement2.appendChild(el).id = jQuery8.expando;
            return !document3.getElementsByName || !document3.getElementsByName(jQuery8.expando).length;
          });
        ...
        find.contains = function(context, elem) {
          ...
          return jQuery8.contains(context, elem);
        };
        ...
        jQuery8.uniqueSort = function(results) {
        ...
        jQuery8.fn.uniqueSort = function() {
          return this.pushStack(jQuery8.uniqueSort(slice.apply(this)));
        };
        Expr = jQuery8.expr = {
          ...
          pseudos: {
            ...
            contains: markFunction(function(text) {
              ...
              return function(elem) {
                return (elem.textContent || jQuery8.text(elem)).indexOf(text) > -1;
              };
            }),
        ...
        jQuery8.find = find;
        jQuery8.expr[":"] = jQuery8.expr.pseudos;
        jQuery8.unique = jQuery8.uniqueSort;
        find.compile = compile;
        find.select = select;
        find.setDocument = setDocument;
        find.tokenize = tokenize;
        find.escape = jQuery8.escapeSelector;
        find.getText = jQuery8.text;
        find.isXML = jQuery8.isXMLDoc;
        find.selectors = jQuery8.expr;
        find.support = jQuery8.support;
        find.uniqueSort = jQuery8.uniqueSort;
      })();
      var dir = function(elem, dir2, until) {
        var matched = [], truncate = until !== void 0;
        while ((elem = elem[dir2]) && elem.nodeType !== 9) {
          if (elem.nodeType === 1) {
            if (truncate && jQuery8(elem).is(until)) {
              break;
            }
            matched.push(elem);
          }
      ...
      var rneedsContext = jQuery8.expr.match.needsContext;
      var rsingleTag = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
      function winnow(elements, qualifier, not) {
        if (isFunction(qualifier)) {
          return jQuery8.grep(elements, function(elem, i2) {
            return !!qualifier.call(elem, i2, elem) !== not;
          });
        }
        if (qualifier.nodeType) {
          return jQuery8.grep(elements, function(elem) {
        ...
        return jQuery8.filter(qualifier, elements, not);
      }
      jQuery8.filter = function(expr, elems, not) {
        var elem = elems[0];
        if (not) {
          expr = ":not(" + expr + ")";
        }
        if (elems.length === 1 && elem.nodeType === 1) {
          return jQuery8.find.matchesSelector(elem, expr) ? [elem] : [];
        }
        return jQuery8.find.matches(expr, jQuery8.grep(elems, function(elem2) {
      ...
      jQuery8.fn.extend({
        find: function(selector) {
          ...
          if (typeof selector !== "string") {
            return this.pushStack(jQuery8(selector).filter(function() {
              for (i2 = 0; i2 < len; i2++) {
                if (jQuery8.contains(self[i2], this)) {
                  return true;
                }
              }
            }));
          ...
          ret = this.pushStack([]);
          for (i2 = 0; i2 < len; i2++) {
            jQuery8.find(selector, self[i2], ret);
          }
          return len > 1 ? jQuery8.uniqueSort(ret) : ret;
        },
        ...
        is: function(selector) {
          return !!winnow(
            ...
            typeof selector === "string" && rneedsContext.test(selector) ? jQuery8(selector) : selector || [],
            false
          ).length;
        }
      });
      var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init2 = jQuery8.fn.init = function(selector, context, root) {
        var match, elem;
        if (!selector) {
          return this;
        }
        ...
        if (typeof selector === "string") {
          ...
          if (match && (match[1] || !context)) {
            if (match[1]) {
              context = context instanceof jQuery8 ? context[0] : context;
              jQuery8.merge(this, jQuery8.parseHTML(
                match[1],
                context && context.nodeType ? context.ownerDocument || context : document2,
                true
              ));
              if (rsingleTag.test(match[1]) && jQuery8.isPlainObject(context)) {
        ...
        return jQuery8.makeArray(selector, this);
      };
      init2.prototype = jQuery8.fn;
      rootjQuery = jQuery8(document2);
      ...
      jQuery8.fn.extend({
        has: function(target) {
          var targets = jQuery8(target, this), l = targets.length;
          return this.filter(function() {
            var i2 = 0;
            for (; i2 < l; i2++) {
              if (jQuery8.contains(this, targets[i2])) {
                return true;
              }
            }
          });
        ...
        closest: function(selectors, context) {
          var cur, i2 = 0, l = this.length, matched = [], targets = typeof selectors !== "string" && jQuery8(selectors);
          if (!rneedsContext.test(selectors)) {
            for (; i2 < l; i2++) {
              for (cur = this[i2]; cur && cur !== context; cur = cur.parentNode) {
                if (cur.nodeType < 11 && (targets ? targets.index(cur) > -1 : (
                  // Don't pass non-elements to jQuery#find
                  cur.nodeType === 1 && jQuery8.find.matchesSelector(cur, selectors)
                ))) {
                  matched.push(cur);
                  break;
                }
          ...
          return this.pushStack(matched.length > 1 ? jQuery8.uniqueSort(matched) : matched);
        },
        ...
        index: function(elem) {
          ...
          if (typeof elem === "string") {
            return indexOf.call(jQuery8(elem), this[0]);
          }
          return indexOf.call(
            this,
        ...
        add: function(selector, context) {
          return this.pushStack(
            jQuery8.uniqueSort(
              jQuery8.merge(this.get(), jQuery8(selector, context))
            )
          );
        },
      ...
      jQuery8.each({
        ...
        contents: function(elem) {
          ...
          return jQuery8.merge([], elem.childNodes);
        }
      }, function(name, fn) {
        jQuery8.fn[name] = function(until, selector) {
          var matched = jQuery8.map(this, fn, until);
          if (name.slice(-5) !== "Until") {
            selector = until;
          }
          if (selector && typeof selector === "string") {
            matched = jQuery8.filter(selector, matched);
          }
          if (this.length > 1) {
            if (!guaranteedUnique[name]) {
              jQuery8.uniqueSort(matched);
            }
      ...
      function createOptions(options) {
        var object = {};
        jQuery8.each(options.match(rnothtmlwhite) || [], function(_, flag) {
          object[flag] = true;
        });
        return object;
      }
      jQuery8.Callbacks = function(options) {
        options = typeof options === "string" ? createOptions(options) : jQuery8.extend({}, options);
        var firing, memory, fired, locked, list = [], queue = [], firingIndex = -1, fire = function() {
          ...
          add: function() {
            if (list) {
              ...
              (function add(args) {
                jQuery8.each(args, function(_, arg) {
                  if (isFunction(arg)) {
          ...
          remove: function() {
            jQuery8.each(arguments, function(_, arg) {
              var index;
              while ((index = jQuery8.inArray(arg, list, index)) > -1) {
                list.splice(index, 1);
          ...
          has: function(fn) {
            return fn ? jQuery8.inArray(fn, list) > -1 : list.length > 0;
          },
      ...
      jQuery8.extend({
        Deferred: function(func) {
          var tuples = [
            ...
            pipe: function() {
              var fns = arguments;
              return jQuery8.Deferred(function(newDefer) {
                jQuery8.each(tuples, function(_i, tuple) {
                ...
                return function() {
                  var that = this, args = arguments, mightThrow = function() {
                    ...
                    try {
                      ...
                      if (jQuery8.Deferred.exceptionHook) {
                        jQuery8.Deferred.exceptionHook(
                          e,
                          process.error
                        );
                      }
                  ...
                  if (depth) {
                    ...
                    if (jQuery8.Deferred.getErrorHook) {
                      process.error = jQuery8.Deferred.getErrorHook();
                    } else if (jQuery8.Deferred.getStackHook) {
                      process.error = jQuery8.Deferred.getStackHook();
                    }
            ...
            promise: function(obj) {
              return obj != null ? jQuery8.extend(obj, promise) : promise;
            }
          }, deferred = {};
          jQuery8.each(tuples, function(i2, tuple) {
        ...
        when: function(singleValue) {
          var remaining = arguments.length, i2 = remaining, resolveContexts = Array(i2), resolveValues = slice.call(arguments), primary = jQuery8.Deferred(), updateFunc = function(i3) {
      ...
      jQuery8.Deferred.exceptionHook = function(error, asyncError) {
      ...
      jQuery8.readyException = function(error) {
        window2.setTimeout(function() {
          throw error;
        });
      };
      var readyList = jQuery8.Deferred();
      jQuery8.fn.ready = function(fn) {
        readyList.then(fn).catch(function(error) {
          jQuery8.readyException(error);
        });
        return this;
      };
      jQuery8.extend({
        ...
        ready: function(wait) {
          if (wait === true ? --jQuery8.readyWait : jQuery8.isReady) {
            return;
          }
          jQuery8.isReady = true;
          if (wait !== true && --jQuery8.readyWait > 0) {
            return;
          }
          readyList.resolveWith(document2, [jQuery8]);
        }
      });
      jQuery8.ready.then = readyList.then;
      function completed() {
      ...
      if (document2.readyState === "complete" || document2.readyState !== "loading" && !document2.documentElement.doScroll) {
        window2.setTimeout(jQuery8.ready);
      } else {
          ...
          if (bulk) {
            if (raw) {
              ...
              fn = function(elem, _key, value2) {
                return bulk.call(jQuery8(elem), value2);
              };
            }
          }
          if (fn) {
      ...
      function Data() {
        this.expando = jQuery8.expando + Data.uid++;
      }
      Data.uid = 1;
      Data.prototype = {
        ...
        remove: function(owner, key) {
          ...
          if (key === void 0 || jQuery8.isEmptyObject(cache)) {
            if (owner.nodeType) {
        ...
        hasData: function(owner) {
          ...
          return cache !== void 0 && !jQuery8.isEmptyObject(cache);
        }
      };
      ...
      jQuery8.extend({
          ...
          if (elem) {
            ...
            if (data) {
              if (!queue || Array.isArray(data)) {
                queue = dataPriv.access(elem, type, jQuery8.makeArray(data));
              } else {
                queue.push(data);
              }
            }
        ...
        dequeue: function(elem, type) {
          type = type || "fx";
          var queue = jQuery8.queue(elem, type), startLength = queue.length, fn = queue.shift(), hooks = jQuery8._queueHooks(elem, type), next = function() {
            jQuery8.dequeue(elem, type);
          };
          if (fn === "inprogress") {
            fn = queue.shift();
            startLength--;
        ...
        _queueHooks: function(elem, type) {
          ...
          return dataPriv.get(elem, key) || dataPriv.access(elem, key, {
            empty: jQuery8.Callbacks("once memory").add(function() {
      ...
      jQuery8.fn.extend({
        queue: function(type, data) {
          ...
          if (arguments.length < setter) {
            return jQuery8.queue(this[0], type);
          }
          return data === void 0 ? this : this.each(function() {
            var queue = jQuery8.queue(this, type, data);
            jQuery8._queueHooks(this, type);
            if (type === "fx" && queue[0] !== "inprogress") {
              jQuery8.dequeue(this, type);
            }
          });
        },
        ...
        promise: function(type, obj) {
          var tmp, count = 1, defer = jQuery8.Deferred(), elements = this, i2 = this.length, resolve = function() {
            if (!--count) {
      ...
      var isAttached = function(elem) {
        return jQuery8.contains(elem.ownerDocument, elem);
      }, composed = { composed: true };
      if (documentElement.getRootNode) {
        isAttached = function(elem) {
          return jQuery8.contains(elem.ownerDocument, elem) || elem.getRootNode(composed) === elem.ownerDocument;
        };
      }
      var isHiddenWithinTree = function(elem, el) {
        ...
        // in the document.
        isAttached(elem) && jQuery8.css(elem, "display") === "none";
      };
      function adjustCSS(elem, prop, valueParts, tween) {
        var adjusted, scale, maxIterations = 20, currentValue = tween ? function() {
          return tween.cur();
        } : function() {
          return jQuery8.css(elem, prop, "");
        }, initial = currentValue(), unit = valueParts && valueParts[3] || (jQuery8.cssNumber[prop] ? "" : "px"), initialInUnit = elem.nodeType && (jQuery8.cssNumber[prop] || unit !== "px" && +initial) && rcssNum.exec(jQuery8.css(elem, prop));
        if (initialInUnit && initialInUnit[3] !== unit) {
          initial = initial / 2;
          unit = unit || initialInUnit[3];
          initialInUnit = +initial || 1;
          while (maxIterations--) {
            jQuery8.style(elem, prop, initialInUnit + unit);
      ...
      function getDefaultDisplay(elem) {
        ...
        display = jQuery8.css(temp, "display");
      ...
      function getAll(context, tag) {
        ...
        if (tag === void 0 || tag && nodeName(context, tag)) {
          return jQuery8.merge([context], ret);
        }
        return ret;
      }
      ...
      function buildFragment(elems, context, scripts, selection, ignored) {
        ...
        for (; i2 < l; i2++) {
          ...
          if (elem || elem === 0) {
            if (toType(elem) === "object") {
              jQuery8.merge(nodes, elem.nodeType ? [elem] : elem);
              ...
              tmp.innerHTML = wrap[1] + jQuery8.htmlPrefilter(elem) + wrap[2];
              j = wrap[0];
              while (j--) {
                tmp = tmp.lastChild;
              }
              jQuery8.merge(nodes, tmp.childNodes);
        ...
        i2 = 0;
        while (elem = nodes[i2++]) {
          if (selection && jQuery8.inArray(elem, selection) > -1) {
            if (ignored) {
              ignored.push(elem);
            }
            continue;
      ...
      function on(elem, types, selector, data, fn, one) {
        ...
        if (one === 1) {
          ...
          fn.guid = origFn.guid || (origFn.guid = jQuery8.guid++);
        }
        return elem.each(function() {
          jQuery8.event.add(this, types, fn, data, selector);
        });
      }
      jQuery8.event = {
        global: {},
        add: function(elem, types, handler, data, selector) {
          ...
          if (selector) {
            jQuery8.find.matchesSelector(documentElement, selector);
          }
          if (!handler.guid) {
            handler.guid = jQuery8.guid++;
          }
          ...
          if (!(eventHandle = elemData.handle)) {
            eventHandle = elemData.handle = function(e) {
              return typeof jQuery8 !== "undefined" && jQuery8.event.triggered !== e.type ? jQuery8.event.dispatch.apply(elem, arguments) : void 0;
            };
          }
          ...
          while (t--) {
            ...
            special = jQuery8.event.special[type] || {};
            type = (selector ? special.delegateType : special.bindType) || type;
            special = jQuery8.event.special[type] || {};
            handleObj = jQuery8.extend({
              type,
              origType,
              data,
              handler,
              guid: handler.guid,
              selector,
              needsContext: selector && jQuery8.expr.match.needsContext.test(selector),
            ...
            jQuery8.event.global[type] = true;
          }
        },
        ...
        remove: function(elem, types, handler, selector, mappedTypes) {
          ...
          while (t--) {
            ...
            if (!type) {
              for (type in events) {
                jQuery8.event.remove(elem, type + types[t], handler, selector, true);
              }
              continue;
            }
            special = jQuery8.event.special[type] || {};
            ...
            if (origCount && !handlers.length) {
              if (!special.teardown || special.teardown.call(elem, namespaces, elemData.handle) === false) {
                jQuery8.removeEvent(elem, type, elemData.handle);
              }
              delete events[type];
            }
          }
          if (jQuery8.isEmptyObject(events)) {
            dataPriv.remove(elem, "handle events");
          }
        },
        dispatch: function(nativeEvent) {
          var i2, j, ret, matched, handleObj, handlerQueue, args = new Array(arguments.length), event = jQuery8.event.fix(nativeEvent), handlers = (dataPriv.get(this, "events") || /* @__PURE__ */ Object.create(null))[event.type] || [], special = jQuery8.event.special[event.type] || {};
          args[0] = event;
          ...
          handlerQueue = jQuery8.event.handlers.call(this, event, handlers);
          i2 = 0;
          while ((matched = handlerQueue[i2++]) && !event.isPropagationStopped()) {
            ...
            while ((handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped()) {
              if (!event.rnamespace || handleObj.namespace === false || event.rnamespace.test(handleObj.namespace)) {
                ...
                ret = ((jQuery8.event.special[handleObj.origType] || {}).handle || handleObj.handler).apply(matched.elem, args);
                if (ret !== void 0) {
              ...
              if (cur.nodeType === 1 && !(event.type === "click" && cur.disabled === true)) {
                ...
                for (i2 = 0; i2 < delegateCount; i2++) {
                  ...
                  if (matchedSelectors[sel] === void 0) {
                    matchedSelectors[sel] = handleObj.needsContext ? jQuery8(sel, this).index(cur) > -1 : jQuery8.find(sel, this, null, [cur]).length;
                  }
        ...
        addProp: function(name, hook) {
          Object.defineProperty(jQuery8.Event.prototype, name, {
            enumerable: true,
            configurable: true,
        ...
        fix: function(originalEvent) {
          return originalEvent[jQuery8.expando] ? originalEvent : new jQuery8.Event(originalEvent);
        },
        special: {
          load: {
      ...
      function leverageNative(el, type, isSetup) {
        if (!isSetup) {
          if (dataPriv.get(el, type) === void 0) {
            jQuery8.event.add(el, type, returnTrue);
          }
          return;
        }
        dataPriv.set(el, type, false);
        jQuery8.event.add(el, type, {
          namespace: false,
          handler: function(event) {
            ...
            if (event.isTrigger & 1 && this[type]) {
              ...
              } else if ((jQuery8.event.special[type] || {}).delegateType) {
                event.stopPropagation();
              }
            } else if (saved) {
              dataPriv.set(this, type, jQuery8.event.trigger(
                saved[0],
                saved.slice(1),
                this
              ));
      ...
      jQuery8.removeEvent = function(elem, type, handle) {
        if (elem.removeEventListener) {
          elem.removeEventListener(type, handle);
        }
      };
      jQuery8.Event = function(src, props) {
        if (!(this instanceof jQuery8.Event)) {
          return new jQuery8.Event(src, props);
        }
        if (src && src.type) {
        ...
        if (props) {
          jQuery8.extend(this, props);
        }
        this.timeStamp = src && src.timeStamp || Date.now();
        this[jQuery8.expando] = true;
      };
      jQuery8.Event.prototype = {
        constructor: jQuery8.Event,
      ...
      jQuery8.each({
        ...
        touches: true,
        which: true
      }, jQuery8.event.addProp);
      jQuery8.each({ focus: "focusin", blur: "focusout" }, function(type, delegateType) {
        function focusMappedHandler(nativeEvent) {
          if (document2.documentMode) {
            var handle = dataPriv.get(this, "handle"), event = jQuery8.event.fix(nativeEvent);
            ...
            jQuery8.event.simulate(
              delegateType,
              nativeEvent.target,
              jQuery8.event.fix(nativeEvent)
            );
          }
        }
        jQuery8.event.special[type] = {
        ...
        jQuery8.event.special[delegateType] = {
          setup: function() {
      ...
      jQuery8.each({
        ...
        jQuery8.event.special[orig] = {
          delegateType: fix,
          bindType: fix,
          handle: function(event) {
            var ret, target = this, related = event.relatedTarget, handleObj = event.handleObj;
            if (!related || related !== target && !jQuery8.contains(target, related)) {
      ...
      jQuery8.fn.extend({
        ...
        off: function(types, selector, fn) {
          ...
          if (types && types.preventDefault && types.handleObj) {
            ...
            jQuery8(types.delegateTarget).off(
          ...
          return this.each(function() {
            jQuery8.event.remove(this, types, fn, selector);
          });
        }
      });
      ...
      function manipulationTarget(elem, content) {
        if (nodeName(elem, "table") && nodeName(content.nodeType !== 11 ? content : content.firstChild, "tr")) {
          return jQuery8(elem).children("tbody")[0] || elem;
        }
        return elem;
      }
      ...
      function cloneCopyEvent(src, dest) {
          ...
          if (events) {
            ...
            for (type in events) {
              for (i2 = 0, l = events[type].length; i2 < l; i2++) {
                jQuery8.event.add(dest, type, events[type][i2]);
              }
            }
          }
        }
        if (dataUser.hasData(src)) {
          ...
          udataCur = jQuery8.extend({}, udataOld);
      ...
      function domManip(collection, args, callback, ignored) {
        ...
        if (l) {
          ...
          if (first || ignored) {
            scripts = jQuery8.map(getAll(fragment, "script"), disableScript);
            hasScripts = scripts.length;
            for (; i2 < l; i2++) {
              node = fragment;
              if (i2 !== iNoClone) {
                node = jQuery8.clone(node, true, true);
                if (hasScripts) {
                  jQuery8.merge(scripts, getAll(node, "script"));
                }
              }
            ...
            if (hasScripts) {
              ...
              jQuery8.map(scripts, restoreScript);
              for (i2 = 0; i2 < hasScripts; i2++) {
                node = scripts[i2];
                if (rscriptType.test(node.type || "") && !dataPriv.access(node, "globalEval") && jQuery8.contains(doc, node)) {
                  if (node.src && (node.type || "").toLowerCase() !== "module") {
                    if (jQuery8._evalUrl && !node.noModule) {
                      jQuery8._evalUrl(node.src, {
      ...
      function remove(elem, selector, keepData) {
        var node, nodes = selector ? jQuery8.filter(selector, elem) : elem, i2 = 0;
        for (; (node = nodes[i2]) != null; i2++) {
          if (!keepData && node.nodeType === 1) {
            jQuery8.cleanData(getAll(node));
          }
          if (node.parentNode) {
      ...
      jQuery8.extend({
        ...
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
          ...
          if (!support.noCloneChecked && (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery8.isXMLDoc(elem)) {
        ...
        cleanData: function(elems) {
          var data, elem, type, special = jQuery8.event.special, i2 = 0;
              ...
              if (data = elem[dataPriv.expando]) {
                if (data.events) {
                  for (type in data.events) {
                    if (special[type]) {
                      jQuery8.event.remove(elem, type);
                    } else {
                      jQuery8.removeEvent(elem, type, data.handle);
                    }
                  }
                }
      ...
      jQuery8.fn.extend({
        ...
        text: function(value) {
          return access(this, function(value2) {
            return value2 === void 0 ? jQuery8.text(this) : this.empty().each(function() {
        ...
        empty: function() {
          ...
          for (; (elem = this[i2]) != null; i2++) {
            if (elem.nodeType === 1) {
              jQuery8.cleanData(getAll(elem, false));
              elem.textContent = "";
            }
          }
          return this;
        ...
        clone: function(dataAndEvents, deepDataAndEvents) {
          ...
          return this.map(function() {
            return jQuery8.clone(this, dataAndEvents, deepDataAndEvents);
          });
        },
        html: function(value) {
          return access(this, function(value2) {
            ...
            if (typeof value2 === "string" && !rnoInnerhtml.test(value2) && !wrapMap[(rtagName.exec(value2) || ["", ""])[1].toLowerCase()]) {
              value2 = jQuery8.htmlPrefilter(value2);
              try {
                for (; i2 < l; i2++) {
                  elem = this[i2] || {};
                  if (elem.nodeType === 1) {
        ...
        replaceWith: function() {
          ...
          return domManip(this, arguments, function(elem) {
            ...
            if (jQuery8.inArray(this, ignored) < 0) {
              jQuery8.cleanData(getAll(this));
              if (parent) {
      ...
      jQuery8.each({
        ...
        jQuery8.fn[name] = function(selector) {
          var elems, ret = [], insert = jQuery8(selector), last = insert.length - 1, i2 = 0;
          for (; i2 <= last; i2++) {
            elems = i2 === last ? this : this.clone(true);
            jQuery8(insert[i2])[original](elems);
      ...
      function finalPropName(name) {
        var final = jQuery8.cssProps[name] || vendorProps[name];
        if (final) {
          return final;
        }
        if (name in emptyStyle) {
      ...
      function boxModelAdjustment(elem, dimension, box, isBorderBox, styles, computedVal) {
        ...
        for (; i2 < 4; i2 += 2) {
          if (box === "margin") {
            marginDelta += jQuery8.css(elem, box + cssExpand[i2], true, styles);
          }
          if (!isBorderBox) {
            delta += jQuery8.css(elem, "padding" + cssExpand[i2], true, styles);
            if (box !== "padding") {
              delta += jQuery8.css(elem, "border" + cssExpand[i2] + "Width", true, styles);
            } else {
              extra += jQuery8.css(elem, "border" + cssExpand[i2] + "Width", true, styles);
            }
          } else {
            if (box === "content") {
              delta -= jQuery8.css(elem, "padding" + cssExpand[i2], true, styles);
      ...
      function getWidthOrHeight(elem, dimension, extra) {
        var styles = getStyles(elem), boxSizingNeeded = !support.boxSizingReliable() || extra, isBorderBox = boxSizingNeeded && jQuery8.css(elem, "boxSizing", false, styles) === "border-box", valueIsBorderBox = isBorderBox, val = curCSS(elem, dimension, styles), offsetProp = "offset" + dimension[0].toUpperCase() + dimension.slice(1);
        ...
        !parseFloat(val) && jQuery8.css(elem, "display", false, styles) === "inline") && // Make sure the element is visible & connected
        elem.getClientRects().length) {
          isBorderBox = jQuery8.css(elem, "boxSizing", false, styles) === "border-box";
      ...
      jQuery8.extend({
        ...
        style: function(elem, name, value, extra) {
          ...
          hooks = jQuery8.cssHooks[name] || jQuery8.cssHooks[origName];
          if (value !== void 0) {
            type = typeof value;
            ...
            if (type === "number" && !isCustomProp) {
              value += ret && ret[3] || (jQuery8.cssNumber[origName] ? "" : "px");
            }
      ...
      jQuery8.each(["height", "width"], function(_i, dimension) {
        jQuery8.cssHooks[dimension] = {
          get: function(elem, computed, extra) {
            if (computed) {
              return rdisplayswap.test(jQuery8.css(elem, "display")) && // Support: Safari 8+
          ...
          set: function(elem, value, extra) {
            var matches, styles = getStyles(elem), scrollboxSizeBuggy = !support.scrollboxSize() && styles.position === "absolute", boxSizingNeeded = scrollboxSizeBuggy || extra, isBorderBox = boxSizingNeeded && jQuery8.css(elem, "boxSizing", false, styles) === "border-box", subtract = extra ? boxModelAdjustment(
              elem,
              dimension,
              extra,
              isBorderBox,
            ...
            if (subtract && (matches = rcssNum.exec(value)) && (matches[3] || "px") !== "px") {
              ...
              value = jQuery8.css(elem, dimension);
            }
            return setPositiveNumber(elem, value, subtract);
          }
        };
      });
      jQuery8.cssHooks.marginLeft = addGetHookIf(
      ...
      jQuery8.each({
        ...
        jQuery8.cssHooks[prefix + suffix] = {
        ...
        if (prefix !== "margin") {
          jQuery8.cssHooks[prefix + suffix].set = setPositiveNumber;
        }
      });
      jQuery8.fn.extend({
        css: function(name, value) {
          return access(this, function(elem, name2, value2) {
            ...
            if (Array.isArray(name2)) {
              ...
              len = name2.length;
              for (; i2 < len; i2++) {
                map[name2[i2]] = jQuery8.css(elem, name2[i2], false, styles);
              }
              return map;
            }
            return value2 !== void 0 ? jQuery8.style(elem, name2, value2) : jQuery8.css(elem, name2);
      ...
      Tween.prototype = {
        ...
        init: function(elem, options, prop, end, easing, unit) {
          this.elem = elem;
          this.prop = prop;
          this.easing = easing || jQuery8.easing._default;
          this.options = options;
          this.start = this.now = this.cur();
          this.end = end;
          this.unit = unit || (jQuery8.cssNumber[prop] ? "" : "px");
        },
        cur: function() {
        ...
        run: function(percent) {
          ...
          if (this.options.duration) {
            this.pos = eased = jQuery8.easing[this.easing](
              percent,
      ...
      Tween.propHooks = {
        _default: {
          get: function(tween) {
            ...
            result = jQuery8.css(tween.elem, tween.prop, "");
            return !result || result === "auto" ? 0 : result;
          },
          set: function(tween) {
            if (jQuery8.fx.step[tween.prop]) {
              jQuery8.fx.step[tween.prop](tween);
            } else if (tween.elem.nodeType === 1 && (jQuery8.cssHooks[tween.prop] || tween.elem.style[finalPropName(tween.prop)] != null)) {
              jQuery8.style(tween.elem, tween.prop, tween.now + tween.unit);
            } else {
      ...
      jQuery8.fx = Tween.prototype.init;
      jQuery8.fx.step = {};
      ...
      function schedule() {
        if (inProgress) {
          if (document2.hidden === false && window2.requestAnimationFrame) {
            ...
            window2.setTimeout(schedule, jQuery8.fx.interval);
          }
          jQuery8.fx.tick();
        }
      }
      ...
      function defaultPrefilter(elem, props, opts) {
        ...
        if (!opts.queue) {
          hooks = jQuery8._queueHooks(elem, "fx");
          ...
          anim.always(function() {
            anim.always(function() {
              hooks.unqueued--;
              if (!jQuery8.queue(elem, "fx").length) {
                hooks.empty.fire();
              }
            });
          });
        ...
        for (prop in props) {
          ...
          if (rfxtypes.test(value)) {
            ...
            orig[prop] = dataShow && dataShow[prop] || jQuery8.style(elem, prop);
          }
        }
        propTween = !jQuery8.isEmptyObject(props);
        if (!propTween && jQuery8.isEmptyObject(orig)) {
          return;
        }
        if (isBox && elem.nodeType === 1) {
          ...
          display = jQuery8.css(elem, "display");
          if (display === "none") {
            if (restoreDisplay) {
          ...
          if (display === "inline" || display === "inline-block" && restoreDisplay != null) {
            if (jQuery8.css(elem, "float") === "none") {
              if (!propTween) {
                anim.done(function() {
        ...
        for (prop in orig) {
          if (!propTween) {
            ...
            anim.done(function() {
              ...
              for (prop in orig) {
                jQuery8.style(elem, prop, orig[prop]);
              }
            });
          }
      ...
      function Animation(elem, properties, options) {
        var result, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery8.Deferred().always(function() {
          delete tick.elem;
        }), tick = function() {
          if (stopped) {
            return false;
          ...
          elem,
          props: jQuery8.extend({}, properties),
          opts: jQuery8.extend(true, {
            specialEasing: {},
            easing: jQuery8.easing._default
          }, options),
        ...
        for (; index < length; index++) {
          ...
          if (result) {
            if (isFunction(result.stop)) {
              jQuery8._queueHooks(animation.elem, animation.opts.queue).stop = result.stop.bind(result);
            }
            return result;
          }
        }
        jQuery8.map(props, createTween, animation);
      ...
      jQuery8.Animation = jQuery8.extend(Animation, {
        tweeners: {
          "*": [function(prop, value) {
      ...
      jQuery8.speed = function(speed, easing, fn) {
        var opt = speed && typeof speed === "object" ? jQuery8.extend({}, speed) : {
        ...
        if (jQuery8.fx.off) {
          ...
          if (typeof opt.duration !== "number") {
            if (opt.duration in jQuery8.fx.speeds) {
              opt.duration = jQuery8.fx.speeds[opt.duration];
            } else {
              opt.duration = jQuery8.fx.speeds._default;
            }
          }
        }
        ...
        opt.complete = function() {
          ...
          if (opt.queue) {
            jQuery8.dequeue(this, opt.queue);
          }
        };
        return opt;
      };
      jQuery8.fn.extend({
        ...
        animate: function(prop, speed, easing, callback) {
          var empty = jQuery8.isEmptyObject(prop), optall = jQuery8.speed(speed, easing, callback), doAnimation = function() {
            var anim = Animation(this, jQuery8.extend({}, prop), optall);
        ...
        stop: function(type, clearQueue, gotoEnd) {
          ...
          return this.each(function() {
            var dequeue = true, index = type != null && type + "queueHooks", timers = jQuery8.timers, data = dataPriv.get(this);
            if (index) {
        ...
        finish: function(type) {
          ...
          return this.each(function() {
            var index, data = dataPriv.get(this), queue = data[type + "queue"], hooks = data[type + "queueHooks"], timers = jQuery8.timers, length = queue ? queue.length : 0;
            data.finish = true;
            jQuery8.queue(this, type, []);
            if (hooks && hooks.stop) {
      ...
      jQuery8.each(["toggle", "show", "hide"], function(_i, name) {
        var cssFn = jQuery8.fn[name];
        jQuery8.fn[name] = function(speed, easing, callback) {
      ...
      jQuery8.timers = [];
      jQuery8.fx.tick = function() {
        var timer, i2 = 0, timers = jQuery8.timers;
        fxNow = Date.now();
      ...
      jQuery8.fx.timer = function(timer) {
        jQuery8.timers.push(timer);
        jQuery8.fx.start();
      };
      jQuery8.fx.interval = 13;
      jQuery8.fx.start = function() {
        if (inProgress) {
          return;
        }
        inProgress = true;
      ...
      jQuery8.fn.delay = function(time, type) {
        time = jQuery8.fx ? jQuery8.fx.speeds[time] || time : time;
        type = type || "fx";
      ...
      var boolHook, attrHandle = jQuery8.expr.attrHandle;
      jQuery8.fn.extend({
        attr: function(name, value) {
          return access(this, jQuery8.attr, name, value, arguments.length > 1);
        },
        removeAttr: function(name) {
          return this.each(function() {
            jQuery8.removeAttr(this, name);
          });
        }
      });
      jQuery8.extend({
        attr: function(elem, name, value) {
          ...
          if (typeof elem.getAttribute === "undefined") {
            return jQuery8.prop(elem, name, value);
          }
          if (nType !== 1 || !jQuery8.isXMLDoc(elem)) {
            hooks = jQuery8.attrHooks[name.toLowerCase()] || (jQuery8.expr.match.bool.test(name) ? boolHook : void 0);
          }
          if (value !== void 0) {
            if (value === null) {
              jQuery8.removeAttr(elem, name);
              return;
            }
          ...
          ret = jQuery8.find.attr(elem, name);
      ...
      jQuery8.each(jQuery8.expr.match.bool.source.match(/\w+/g), function(_i, name) {
        var getter = attrHandle[name] || jQuery8.find.attr;
      ...
      jQuery8.fn.extend({
        prop: function(name, value) {
          return access(this, jQuery8.prop, name, value, arguments.length > 1);
        },
        removeProp: function(name) {
          return this.each(function() {
            delete this[jQuery8.propFix[name] || name];
          });
        }
      });
      jQuery8.extend({
        prop: function(elem, name, value) {
          ...
          if (nType !== 1 || !jQuery8.isXMLDoc(elem)) {
            name = jQuery8.propFix[name] || name;
            hooks = jQuery8.propHooks[name];
          }
          if (value !== void 0) {
            if (hooks && "set" in hooks && (ret = hooks.set(elem, value, name)) !== void 0) {
              return ret;
        ...
        propHooks: {
          tabIndex: {
            get: function(elem) {
              var tabindex = jQuery8.find.attr(elem, "tabindex");
              if (tabindex) {
      ...
      jQuery8.each([
        ...
        jQuery8.propFix[this.toLowerCase()] = this;
      });
      ...
      jQuery8.fn.extend({
        addClass: function(value) {
          ...
          if (isFunction(value)) {
            return this.each(function(j) {
              jQuery8(this).addClass(value.call(this, j, getClass(this)));
            });
          }
        ...
        removeClass: function(value) {
          ...
          if (isFunction(value)) {
            return this.each(function(j) {
              jQuery8(this).removeClass(value.call(this, j, getClass(this)));
            });
          }
          if (!arguments.length) {
      ...
      jQuery8.fn.extend({
        val: function(value) {
          ...
          if (!arguments.length) {
            if (elem) {
              hooks = jQuery8.valHooks[elem.type] || jQuery8.valHooks[elem.nodeName.toLowerCase()];
          ...
          return this.each(function(i2) {
            ...
            if (valueIsFunction) {
              val = value.call(this, i2, jQuery8(this).val());
            } else {
              val = value;
            }
            if (val == null) {
              ...
              val = jQuery8.map(val, function(value2) {
                return value2 == null ? "" : value2 + "";
              });
            }
            hooks = jQuery8.valHooks[this.type] || jQuery8.valHooks[this.nodeName.toLowerCase()];
      ...
      jQuery8.extend({
        valHooks: {
          option: {
            get: function(elem) {
              var val = jQuery8.find.attr(elem, "value");
              return val != null ? val : (
                // Support: IE <=10 - 11 only
                // option.text throws exceptions (trac-14686, trac-14858)
                // Strip and collapse whitespace
                // https://html.spec.whatwg.org/#strip-and-collapse-whitespace
                stripAndCollapse(jQuery8.text(elem))
              );
            }
          },
          select: {
            ...
            set: function(elem, value) {
              var optionSet, option, options = elem.options, values = jQuery8.makeArray(value), i2 = options.length;
              while (i2--) {
                option = options[i2];
                if (option.selected = jQuery8.inArray(jQuery8.valHooks.option.get(option), values) > -1) {
                  optionSet = true;
                }
              }
              if (!optionSet) {
      ...
      jQuery8.each(["radio", "checkbox"], function() {
        jQuery8.valHooks[this] = {
          set: function(elem, value) {
            if (Array.isArray(value)) {
              return elem.checked = jQuery8.inArray(jQuery8(elem).val(), value) > -1;
            }
          }
        };
        if (!support.checkOn) {
          jQuery8.valHooks[this].get = function(elem) {
      ...
      var rquery = /\?/;
      jQuery8.parseXML = function(data) {
        ...
        if (!xml || parserErrorElem) {
          jQuery8.error("Invalid XML: " + (parserErrorElem ? jQuery8.map(parserErrorElem.childNodes, function(el) {
      ...
      jQuery8.extend(jQuery8.event, {
        trigger: function(event, data, elem, onlyHandlers) {
          ...
          if (rfocusMorph.test(type + jQuery8.event.triggered)) {
            return;
          }
          if (type.indexOf(".") > -1) {
          ...
          event = event[jQuery8.expando] ? event : new jQuery8.Event(type, typeof event === "object" && event);
          ...
          data = data == null ? [event] : jQuery8.makeArray(data, [event]);
          special = jQuery8.event.special[type] || {};
          ...
          if (!onlyHandlers && !event.isDefaultPrevented()) {
            if ((!special._default || special._default.apply(eventPath.pop(), data) === false) && acceptData(elem)) {
              if (ontype && isFunction(elem[type]) && !isWindow(elem)) {
                ...
                jQuery8.event.triggered = void 0;
                if (tmp) {
                  elem[ontype] = tmp;
                }
              }
        ...
        simulate: function(type, elem, event) {
          ...
          jQuery8.event.trigger(e, null, elem);
        }
      });
      jQuery8.fn.extend({
        trigger: function(type, data) {
          return this.each(function() {
            jQuery8.event.trigger(type, data, this);
          });
        },
        triggerHandler: function(type, data) {
          var elem = this[0];
          if (elem) {
            return jQuery8.event.trigger(type, data, elem, true);
          }
        }
      });
      ...
      function buildParams(prefix, obj, traditional, add) {
        ...
        if (Array.isArray(obj)) {
          jQuery8.each(obj, function(i2, v) {
      ...
      jQuery8.param = function(a, traditional) {
        ...
        if (Array.isArray(a) || a.jquery && !jQuery8.isPlainObject(a)) {
          jQuery8.each(a, function() {
      ...
      jQuery8.fn.extend({
        serialize: function() {
          return jQuery8.param(this.serializeArray());
        },
        serializeArray: function() {
          return this.map(function() {
            var elements = jQuery8.prop(this, "elements");
            return elements ? jQuery8.makeArray(elements) : this;
          }).filter(function() {
            var type = this.type;
            return this.name && !jQuery8(this).is(":disabled") && rsubmittable.test(this.nodeName) && !rsubmitterTypes.test(type) && (this.checked || !rcheckableType.test(type));
          }).map(function(_i, elem) {
            var val = jQuery8(this).val();
            if (val == null) {
              return null;
            }
            if (Array.isArray(val)) {
              return jQuery8.map(val, function(val2) {
      ...
      function inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR) {
        ...
        function inspect(dataType) {
          ...
          jQuery8.each(structure[dataType] || [], function(_, prefilterOrFactory) {
      ...
      function ajaxExtend(target, src) {
        var key, deep, flatOptions = jQuery8.ajaxSettings.flatOptions || {};
        for (key in src) {
          if (src[key] !== void 0) {
        ...
        if (deep) {
          jQuery8.extend(true, target, deep);
        }
        return target;
      }
      ...
      jQuery8.extend({
        ...
        ajaxSetup: function(target, settings) {
          return settings ? (
            ...
            ajaxExtend(ajaxExtend(target, jQuery8.ajaxSettings), settings)
          ) : (
            // Extending ajaxSettings
            ajaxExtend(jQuery8.ajaxSettings, target)
          );
        },
        ...
        ajax: function(url, options) {
          ...
          options = options || {};
          var transport, cacheURL, responseHeadersString, responseHeaders, timeoutTimer, urlAnchor, completed2, fireGlobals, i2, uncached, s = jQuery8.ajaxSetup({}, options), callbackContext = s.context || s, globalEventContext = s.context && (callbackContext.nodeType || callbackContext.jquery) ? jQuery8(callbackContext) : jQuery8.event, deferred = jQuery8.Deferred(), completeDeferred = jQuery8.Callbacks("once memory"), statusCode = s.statusCode || {}, requestHeaders = {}, requestHeadersNames = {}, strAbort = "canceled", jqXHR = {
            readyState: 0,
          ...
          if (s.data && s.processData && typeof s.data !== "string") {
            s.data = jQuery8.param(s.data, s.traditional);
          }
          inspectPrefiltersOrTransports(prefilters, s, options, jqXHR);
          if (completed2) {
            return jqXHR;
          }
          fireGlobals = jQuery8.event && s.global;
          if (fireGlobals && jQuery8.active++ === 0) {
            jQuery8.event.trigger("ajaxStart");
          }
          ...
          if (s.ifModified) {
            if (jQuery8.lastModified[cacheURL]) {
              jqXHR.setRequestHeader("If-Modified-Since", jQuery8.lastModified[cacheURL]);
            }
            if (jQuery8.etag[cacheURL]) {
              jqXHR.setRequestHeader("If-None-Match", jQuery8.etag[cacheURL]);
            }
          }
          ...
          function done(status, nativeStatusText, responses, headers) {
            ...
            if (!isSuccess && jQuery8.inArray("script", s.dataTypes) > -1 && jQuery8.inArray("json", s.dataTypes) < 0) {
            ...
            if (isSuccess) {
              if (s.ifModified) {
                ...
                if (modified) {
                  jQuery8.lastModified[cacheURL] = modified;
                }
                modified = jqXHR.getResponseHeader("etag");
                if (modified) {
                  jQuery8.etag[cacheURL] = modified;
                }
              }
            ...
            if (fireGlobals) {
              ...
              if (!--jQuery8.active) {
                jQuery8.event.trigger("ajaxStop");
              }
            }
          }
          return jqXHR;
        ...
        getJSON: function(url, data, callback) {
          return jQuery8.get(url, data, callback, "json");
        },
        getScript: function(url, callback) {
          return jQuery8.get(url, void 0, callback, "script");
        }
      });
      jQuery8.each(["get", "post"], function(_i, method) {
        jQuery8[method] = function(url, data, callback, type) {
          if (isFunction(data)) {
            type = type || callback;
            callback = data;
            data = void 0;
          }
          return jQuery8.ajax(jQuery8.extend({
            url,
            type: method,
            dataType: type,
            data,
            success: callback
          }, jQuery8.isPlainObject(url) && url));
        };
      });
      jQuery8.ajaxPrefilter(function(s) {
        var i2;
        for (i2 in s.headers) {
      ...
      jQuery8._evalUrl = function(url, options, doc) {
        return jQuery8.ajax({
          url,
          ...
          dataFilter: function(response) {
            jQuery8.globalEval(response, options, doc);
          }
        });
      };
      jQuery8.fn.extend({
        wrapAll: function(html) {
          ...
          if (this[0]) {
            ...
            wrap = jQuery8(html, this[0].ownerDocument).eq(0).clone(true);
        ...
        wrapInner: function(html) {
          if (isFunction(html)) {
            return this.each(function(i2) {
              jQuery8(this).wrapInner(html.call(this, i2));
            });
          }
          return this.each(function() {
            var self = jQuery8(this), contents = self.contents();
            if (contents.length) {
        ...
        wrap: function(html) {
          ...
          return this.each(function(i2) {
            jQuery8(this).wrapAll(htmlIsFunction ? html.call(this, i2) : html);
          });
        },
        unwrap: function(selector) {
          this.parent(selector).not("body").each(function() {
            jQuery8(this).replaceWith(this.childNodes);
          });
          return this;
        }
      });
      jQuery8.expr.pseudos.hidden = function(elem) {
        return !jQuery8.expr.pseudos.visible(elem);
      };
      jQuery8.expr.pseudos.visible = function(elem) {
        return !!(elem.offsetWidth || elem.offsetHeight || elem.getClientRects().length);
      };
      jQuery8.ajaxSettings.xhr = function() {
        try {
      ...
      var xhrSuccessStatus = {
        ...
        1223: 204
      }, xhrSupported = jQuery8.ajaxSettings.xhr();
      support.cors = !!xhrSupported && "withCredentials" in xhrSupported;
      support.ajax = xhrSupported = !!xhrSupported;
      jQuery8.ajaxTransport(function(options) {
      ...
      jQuery8.ajaxSetup({
        ...
        converters: {
          "text script": function(text) {
            jQuery8.globalEval(text);
            return text;
          }
        }
      });
      jQuery8.ajaxPrefilter("script", function(s) {
        if (s.cache === void 0) {
          s.cache = false;
        }
        if (s.crossDomain) {
      ...
      jQuery8.ajaxTransport("script", function(s) {
        if (s.crossDomain || s.scriptAttrs) {
          var script, callback;
          return {
            send: function(_, complete) {
              script = jQuery8("<script>").attr(s.scriptAttrs || {}).prop({ charset: s.scriptCharset, src: s.url }).on("load error", callback = function(evt) {
                script.remove();
                callback = null;
                if (evt) {
      ...
      jQuery8.ajaxSetup({
        ...
        jsonpCallback: function() {
          var callback = oldCallbacks.pop() || jQuery8.expando + "_" + nonce.guid++;
          this[callback] = true;
          return callback;
        }
      });
      jQuery8.ajaxPrefilter("json jsonp", function(s, originalSettings, jqXHR) {
        ...
        if (jsonProp || s.dataTypes[0] === "jsonp") {
          ...
          s.converters["script json"] = function() {
            if (!responseContainer) {
              jQuery8.error(callbackName + " was not called");
            }
          ...
          jqXHR.always(function() {
            if (overwritten === void 0) {
              jQuery8(window2).removeProp(callbackName);
            } else {
      ...
      jQuery8.parseHTML = function(data, context, keepScripts) {
        if (typeof data !== "string") {
          return [];
        }
        ...
        if (scripts && scripts.length) {
          jQuery8(scripts).remove();
        }
        return jQuery8.merge([], parsed.childNodes);
      };
      jQuery8.fn.load = function(url, params, callback) {
        ...
        if (self.length > 0) {
          jQuery8.ajax({
            ...
            self.html(selector ? (
              ...
              jQuery8("<div>").append(jQuery8.parseHTML(responseText)).find(selector)
            ) : (
      ...
      jQuery8.expr.pseudos.animated = function(elem) {
        return jQuery8.grep(jQuery8.timers, function(fn) {
          return elem === fn.elem;
        }).length;
      };
      jQuery8.offset = {
        setOffset: function(elem, options, i2) {
          var curPosition, curLeft, curCSSTop, curTop, curOffset, curCSSLeft, calculatePosition, position = jQuery8.css(elem, "position"), curElem = jQuery8(elem), props = {};
          if (position === "static") {
            elem.style.position = "relative";
          }
          curOffset = curElem.offset();
          curCSSTop = jQuery8.css(elem, "top");
          curCSSLeft = jQuery8.css(elem, "left");
          ...
          if (isFunction(options)) {
            options = options.call(elem, i2, jQuery8.extend({}, curOffset));
          }
          if (options.top != null) {
      ...
      jQuery8.fn.extend({
        ...
        offset: function(options) {
          if (arguments.length) {
            return options === void 0 ? this : this.each(function(i2) {
              jQuery8.offset.setOffset(this, options, i2);
            });
          }
        ...
        position: function() {
          ...
          if (jQuery8.css(elem, "position") === "fixed") {
            offset = elem.getBoundingClientRect();
          } else {
            offset = this.offset();
            doc = elem.ownerDocument;
            offsetParent = elem.offsetParent || doc.documentElement;
            while (offsetParent && (offsetParent === doc.body || offsetParent === doc.documentElement) && jQuery8.css(offsetParent, "position") === "static") {
              offsetParent = offsetParent.parentNode;
            }
            if (offsetParent && offsetParent !== elem && offsetParent.nodeType === 1) {
              parentOffset = jQuery8(offsetParent).offset();
              parentOffset.top += jQuery8.css(offsetParent, "borderTopWidth", true);
              parentOffset.left += jQuery8.css(offsetParent, "borderLeftWidth", true);
            }
          }
          return {
            top: offset.top - parentOffset.top - jQuery8.css(elem, "marginTop", true),
            left: offset.left - parentOffset.left - jQuery8.css(elem, "marginLeft", true)
          };
        },
        ...
        offsetParent: function() {
          return this.map(function() {
            ...
            while (offsetParent && jQuery8.css(offsetParent, "position") === "static") {
      ...
      jQuery8.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(method, prop) {
        var top = "pageYOffset" === prop;
        jQuery8.fn[method] = function(val) {
      ...
      jQuery8.each(["top", "left"], function(_i, prop) {
        jQuery8.cssHooks[prop] = addGetHookIf(
          support.pixelPosition,
          function(elem, computed) {
            if (computed) {
              computed = curCSS(elem, prop);
              return rnumnonpx.test(computed) ? jQuery8(elem).position()[prop] + "px" : computed;
            }
          }
        );
      });
      jQuery8.each({ Height: "height", Width: "width" }, function(name, type) {
        jQuery8.each({
          padding: "inner" + name,
          content: type,
          "": "outer" + name
        }, function(defaultExtra, funcName) {
          jQuery8.fn[funcName] = function(margin, value) {
            ...
            return access(this, function(elem, type2, value2) {
              ...
              return value2 === void 0 ? (
                ...
                jQuery8.css(elem, type2, extra)
              ) : (
                // Set width or height on the element
                jQuery8.style(elem, type2, value2, extra)
              );
      ...
      jQuery8.each(
        ...
        function(_i, name) {
          jQuery8.fn[name] = function(data, fn) {
            return arguments.length > 0 ? this.on(name, null, data, fn) : this.trigger(name);
          };
        }
      );
      var rtrim = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;
      jQuery8.proxy = function(fn, context) {
        var tmp, args, proxy;
        ...
        proxy.guid = fn.guid = fn.guid || jQuery8.guid++;
        return proxy;
      };
      jQuery8.holdReady = function(hold) {
        if (hold) {
          jQuery8.readyWait++;
        } else {
          jQuery8.ready(true);
      ...
      jQuery8.isArray = Array.isArray;
      jQuery8.parseJSON = JSON.parse;
      jQuery8.nodeName = nodeName;
      jQuery8.isFunction = isFunction;
      jQuery8.isWindow = isWindow;
      jQuery8.camelCase = camelCase;
      jQuery8.type = toType;
      jQuery8.now = Date.now;
      jQuery8.isNumeric = function(obj) {
        var type = jQuery8.type(obj);
        return (type === "number" || type === "string") && // parseFloat NaNs numeric-cast false positives ("")
        // ...but misinterprets leading-number strings, particularly hex literals ("0x...")
        // subtraction forces infinities to NaN
        !isNaN(obj - parseFloat(obj));
      };
      jQuery8.trim = function(text) {
      ...
      jQuery8.noConflict = function(deep) {
        if (window2.$ === jQuery8) {
          window2.$ = _$;
        }
        if (deep && window2.jQuery === jQuery8) {
          window2.jQuery = _jQuery;
        }
        return jQuery8;
      };
      if (typeof noGlobal === "undefined") {
        window2.jQuery = window2.$ = jQuery8;
      }
      return jQuery8;
    });
  }
...
var DataTable2 = function(selector, options) {
  ...
  this.each(function() {
    ...
    _fnCamelToHungarian2(defaults, $4.extend(oInit, $this.data()), true);
    ...
    var oSettings = $4.extend(true, {}, DataTable2.models.oSettings, {
      "sDestroyWidth": $this[0].style.width,
      "sInstance": sId,
      "sTableId": sId
    });
    ...
    oInit = _fnExtend2($4.extend(true, {}, defaults), oInit);
    ...
    var oClasses = oSettings.oClasses;
    $4.extend(oClasses, DataTable2.ext.classes, oInit.oClasses);
    $this.addClass(oClasses.sTable);
    if (oSettings.iInitDisplayStart === void 0) {
      oSettings.iInitDisplayStart = oInit.iDisplayStart;
      oSettings._iDisplayStart = oInit.iDisplayStart;
    ...
    for (i2 = 0, iLen = aoColumnsInit.length; i2 < iLen; i2++) {
      _fnAddColumn2(oSettings, anThs ? anThs[i2] : null);
    }
      ...
      $4(rowOne[0]).children("th, td").each(function(i3, cell) {
        ...
        if (col.mData === i3) {
          ...
          if (sort !== null || filter !== null) {
            ...
            col._isArrayHost = true;
            _fnColumnOptions2(oSettings, i3);
          }
        }
      });
    }
    ...
    var loadedInit = function() {
      ...
      if (oInit.aaData) {
        for (i2 = 0; i2 < oInit.aaData.length; i2++) {
          _fnAddData2(oSettings, oInit.aaData[i2]);
        }
      } else if (oSettings.bDeferLoading || _fnDataSource2(oSettings) == "dom") {
        _fnAddTr2(oSettings, $4(oSettings.nTBody).children("tr"));
      }
      oSettings.aiDisplay = oSettings.aiDisplayMaster.slice();
      oSettings.bInitialised = true;
      if (bInitHandedOff === false) {
    ...
    if ($4.isPlainObject(source)) {
      ...
      var setData = function(data, val, src) {
        ...
        for (var i2 = 0, iLen = a.length - 1; i2 < iLen; i2++) {
          ...
          arrayNotation = a[i2].match(__reArray2);
          funcNotation = a[i2].match(__reFn2);
          if (arrayNotation) {
            a[i2] = a[i2].replace(__reArray2, "");
            data[a[i2]] = [];
            b = a.slice();
            b.splice(0, i2 + 1);
            innerSrc = b.join(".");
...
function _fnCompatOpts2(init2) {
  ...
  if (searchCols) {
    for (var i2 = 0, ien = searchCols.length; i2 < ien; i2++) {
      if (searchCols[i2]) {
        _fnCamelToHungarian2(DataTable2.models.oSearch, searchCols[i2]);
      }
    }
  }
}
...
function _fnBrowserDetect2(settings) {
  ...
  $4.extend(settings.oBrowser, DataTable2.__browser);
  settings.oScroll.iBarWidth = DataTable2.__browser.barWidth;
}
function _fnReduce2(that, fn, init2, start, end, inc) {
  var i2 = start, value, isSet = false;
  if (init2 !== void 0) {
    value = init2;
    isSet = true;
...
function _fnAddColumn2(oSettings, nTh) {
  ...
  var iCol = oSettings.aoColumns.length;
  var oCol = $4.extend({}, DataTable2.models.oColumn, oDefaults, {
    "nTh": nTh ? nTh : document.createElement("th"),
    "sTitle": oDefaults.sTitle ? oDefaults.sTitle : nTh ? nTh.innerHTML : "",
    "aDataSort": oDefaults.aDataSort ? oDefaults.aDataSort : [iCol],
    "mData": oDefaults.mData ? oDefaults.mData : iCol,
  ...
  oSettings.aoColumns.push(oCol);
  var searchCols = oSettings.aoPreSearchCols;
  searchCols[iCol] = $4.extend({}, DataTable2.models.oSearch, searchCols[iCol]);
  _fnColumnOptions2(oSettings, iCol, $4(nTh).data());
}
  ...
  for (i2 = 0, ien = columns.length; i2 < ien; i2++) {
    ...
    if (!col.sType && col._sManualType) {
      ...
      for (j = 0, jen = types.length; j < jen; j++) {
        for (k = 0, ken = data.length; k < ken; k++) {
          if (cache[k] === void 0) {
            cache[k] = _fnGetCellData2(settings, k, i2, "type");
          }
          detectedType = types[j](cache[k], settings);
          if (!detectedType && j !== types.length - 1) {
            break;
    ...
    for (i2 = aoColDefs.length - 1; i2 >= 0; i2--) {
      ...
      for (j = 0, jLen = aTargets.length; j < jLen; j++) {
        if (typeof aTargets[j] === "number" && aTargets[j] >= 0) {
          ...
          for (k = 0, kLen = columns.length; k < kLen; k++) {
            if (aTargets[j] == "_all" || $4(columns[k].nTh).hasClass(aTargets[j])) {
              fn(k, def);
            }
          }
        }
...
function _fnAddData2(oSettings, aDataIn, nTr, anTds) {
  var iRow = oSettings.aoData.length;
  var oData = $4.extend(true, {}, DataTable2.models.oRow, {
    src: nTr ? "dom" : "data",
    idx: iRow
  });
  oData._aData = aDataIn;
...
function _fnNodeToColumnIndex2(oSettings, iRow, n) {
  return $4.inArray(n, oSettings.aoData[iRow].anCells);
}
...
function _fnSplitObjNotation2(str) {
  return $4.map(str.match(/(\\.|[^\.])+/g) || [""], function(s) {
    return s.replace(/\\\./g, ".");
  });
}
  ...
  if (row.nTr === null) {
    ...
    for (i2 = 0, iLen = oSettings.aoColumns.length; i2 < iLen; i2++) {
      ...
      if (create || (oCol.mRender || oCol.mData !== i2) && (!$4.isPlainObject(oCol.mData) || oCol.mData._ !== i2 + ".display")) {
        nTd.innerHTML = _fnGetCellData2(oSettings, iRow, i2, "display");
      }
      if (oCol.sClass) {
        nTd.className += " " + oCol.sClass;
      }
      ...
      if (oCol.fnCreatedCell) {
        oCol.fnCreatedCell.call(
          oSettings.oInstance,
          nTd,
          _fnGetCellData2(oSettings, iRow, i2),
          rowData,
          iRow,
          i2
        );
...
function _fnBuildHead2(oSettings) {
  ...
  for (i2 = 0, ien = columns.length; i2 < ien; i2++) {
    ...
    if (oSettings.oFeatures.bSort) {
      ...
      if (column.bSortable !== false) {
        cell.attr("tabindex", oSettings.iTabIndex).attr("aria-controls", oSettings.sTableId);
        _fnSortAttachListener2(oSettings, column.nTh, i2);
      }
    }
    if (column.sTitle != cell[0].innerHTML) {
      cell.html(column.sTitle);
  ...
  for (i2 = 0, iLen = aoLocal.length; i2 < iLen; i2++) {
    ...
    for (j = 0, jLen = aoLocal[i2].length; j < jLen; j++) {
      ...
      if (aApplied[i2][j] === void 0) {
        ...
        $4(aoLocal[i2][j].cell).attr("rowspan", iRowspan).attr("colspan", iColspan);
      }
    }
  }
}
...
function _fnFeatureHtmlFilter2(settings) {
  ...
  $4(settings.nTable).on("search.dt.DT", function(ev, s) {
    if (settings === s) {
      try {
        if (jqFilter[0] !== document.activeElement) {
          jqFilter.val(previousSearch.sSearch);
...
function _fnFilterCreateSearch2(search, regex, smart, caseInsensitive) {
  ...
  if (smart) {
    var a = $4.map(search.match(/["\u201C][^"\u201D]+["\u201D]|[^ ]+/g) || [""], function(word) {
      if (word.charAt(0) === '"') {
        var m = word.match(/^"(.*)"$/);
        word = m ? m[1] : word;
      } else if (word.charAt(0) === "“") {
  ...
  for (i2 = 0, ien = settings.aoData.length; i2 < ien; i2++) {
    ...
    if (!row._aFilterData) {
      ...
      for (j = 0, jen = columns.length; j < jen; j++) {
        column = columns[j];
        if (column.bSearchable) {
          cellData = _fnGetCellData2(settings, i2, j, "filter");
          if (cellData === null) {
            cellData = "";
          }
          if (typeof cellData !== "string" && cellData.toString) {
...
function _fnFeatureHtmlInfo2(settings) {
  var tid = settings.sTableId, nodes = settings.aanFeatures.i, n = $4("<div/>", {
    "class": settings.oClasses.sInfo,
    "id": !nodes ? tid + "_info" : null
  });
  if (!nodes) {
...
function _fnFeatureHtmlLength2(settings) {
  ...
  $4("select", div).val(settings._iDisplayLength).on("change.DT", function(e) {
    _fnLengthChange2(settings, $4(this).val());
    _fnDraw2(settings);
  });
  $4(settings.nTable).on("length.dt.DT", function(e, s, len) {
    if (settings === s) {
...
function _fnFeatureHtmlTable2(settings) {
  ...
  var scrollFoot = footer ? children[2] : null;
  if (scrollX) {
    $4(scrollBody).on("scroll.DT", function(e) {
      var scrollLeft = this.scrollLeft;
      scrollHead.scrollLeft = scrollLeft;
      if (footer) {
        scrollFoot.scrollLeft = scrollLeft;
...
function _fnScrollDraw2(settings) {
  var scroll = settings.oScroll, scrollX = scroll.sX, scrollXInner = scroll.sXInner, scrollY = scroll.sY, barWidth = scroll.iBarWidth, divHeader = $4(settings.nScrollHead), divHeaderStyle = divHeader[0].style, divHeaderInner = divHeader.children("div"), divHeaderInnerStyle = divHeaderInner[0].style, divHeaderTable = divHeaderInner.children("table"), divBodyEl = settings.nScrollBody, divBody = $4(divBodyEl), divBodyStyle = divBodyEl.style, divFooter = $4(settings.nScrollFoot), divFooterInner = divFooter.children("div"), divFooterTable = divFooterInner.children("table"), header = $4(settings.nTHead), table = $4(settings.nTable), tableEl = table[0], tableStyle = tableEl.style, footer = settings.nTFoot ? $4(settings.nTFoot) : null, browser = settings.oBrowser, ie67 = browser.bScrollOversize, dtHeaderCells = _pluck2(settings.aoColumns, "nTh"), headerTrgEls, footerTrgEls, headerSrcEls, footerSrcEls, headerCopy, footerCopy, headerWidths = [], footerWidths = [], headerContent = [], footerContent = [], idx, correction, sanityWidth, zeroOut = function(nSizer) {
    var style = nSizer.style;
    style.paddingTop = "0";
    style.paddingBottom = "0";
    style.borderTopWidth = "0";
  ...
  $4.each(_fnGetUniqueThs2(settings, headerCopy), function(i2, el) {
    idx = _fnVisibleToColumnIndex2(settings, i2);
    el.style.width = settings.aoColumns[idx].sWidth;
  });
  if (footer) {
  ...
  _fnApplyToChildren2(function(nSizer) {
    var style = window.getComputedStyle ? window.getComputedStyle(nSizer).width : _fnStringToCss2($4(nSizer).width());
    headerContent.push(nSizer.innerHTML);
    headerWidths.push(style);
  }, headerSrcEls);
  _fnApplyToChildren2(function(nToSize, i2) {
    nToSize.style.width = headerWidths[i2];
  }, headerTrgEls);
  ...
  if (footer) {
    ...
    _fnApplyToChildren2(function(nSizer) {
      footerContent.push(nSizer.innerHTML);
      footerWidths.push(_fnStringToCss2($4(nSizer).css("width")));
    }, footerSrcEls);
    _fnApplyToChildren2(function(nToSize, i2) {
      nToSize.style.width = footerWidths[i2];
    }, footerTrgEls);
  ...
  _fnApplyToChildren2(function(nSizer, i2) {
    nSizer.innerHTML = '<div class="dataTables_sizing">' + headerContent[i2] + "</div>";
    nSizer.childNodes[0].style.height = "0";
    nSizer.childNodes[0].style.overflow = "hidden";
    nSizer.style.width = headerWidths[i2];
...
function _fnCalculateColumnWidths2(oSettings) {
  var table = oSettings.nTable, columns = oSettings.aoColumns, scroll = oSettings.oScroll, scrollY = scroll.sY, scrollX = scroll.sX, scrollXInner = scroll.sXInner, columnCount = columns.length, visibleColumns = _fnGetColumns2(oSettings, "bVisible"), headerCells = $4("th", oSettings.nTHead), tableWidthAttr = table.getAttribute("width"), tableContainer = table.parentNode, userInputs = false, i2, column, columnIdx, width, outerWidth, browser = oSettings.oBrowser, ie67 = browser.bScrollOversize;
  var styleWidth = table.style.width;
  if (styleWidth && styleWidth.indexOf("%") !== -1) {
    tableWidthAttr = styleWidth;
  }
  ...
  if (ie67 || !userInputs && !scrollX && !scrollY && columnCount == _fnVisbleColumns2(oSettings) && columnCount == headerCells.length) {
    for (i2 = 0; i2 < columnCount; i2++) {
      var colIdx = _fnVisibleToColumnIndex2(oSettings, i2);
      if (colIdx !== null) {
        columns[colIdx].sWidth = _fnStringToCss2(headerCells.eq(i2).width());
      }
    }
  } else {
    ...
    for (i2 = 0; i2 < visibleColumns.length; i2++) {
      column = columns[visibleColumns[i2]];
      headerCells[i2].style.width = column.sWidthOrig !== null && column.sWidthOrig !== "" ? _fnStringToCss2(column.sWidthOrig) : "";
      if (column.sWidthOrig && scrollX) {
    ...
    if (oSettings.aoData.length) {
      for (i2 = 0; i2 < visibleColumns.length; i2++) {
        columnIdx = visibleColumns[i2];
        column = columns[columnIdx];
        $4(_fnGetWidestNode2(oSettings, columnIdx)).clone(false).append(column.sContentPadding).appendTo(tr);
      }
    }
    ...
    for (i2 = 0; i2 < visibleColumns.length; i2++) {
      ...
      var bounding = browser.bBounding ? Math.ceil(headerCells[i2].getBoundingClientRect().width) : cell.outerWidth();
      total += bounding;
      columns[visibleColumns[i2]].sWidth = _fnStringToCss2(bounding - border);
    }
  ...
  if ((tableWidthAttr || scrollX) && !oSettings._reszEvt) {
    var bindResize = function() {
      $4(window).on("resize.DT-" + oSettings.sInstance, _fnThrottle2(function() {
...
function _fnConvertToWidth2(widths, parent) {
  ...
  for (var i2 = 0; i2 < widths.length; i2++) {
    if (widths[i2]) {
      els.push(
        $4("<div/>").css("width", _fnStringToCss2(widths[i2])).appendTo(parent || document.body)
      );
    } else {
      els.push(null);
    }
...
function _fnGetWidestNode2(settings, colIdx) {
  ...
  return !data.nTr ? (
    // Might not have been created when deferred rendering
    $4("<td/>").html(_fnGetCellData2(settings, idx, colIdx, "display"))[0]
  ) : data.anCells[colIdx];
}
function _fnGetMaxLenString2(settings, colIdx) {
  var s, max = -1, maxIdx = -1;
  for (var i2 = 0, ien = settings.aoData.length; i2 < ien; i2++) {
    s = _fnGetCellData2(settings, i2, colIdx, "display") + "";
...
function _fnSortFlatten2(settings) {
  var i2, iLen, k, kLen, aSort = [], aiOrig = [], aoColumns = settings.aoColumns, aDataSort, iCol, sType, srcCol, fixed = settings.aaSortingFixed, fixedObj = $4.isPlainObject(fixed), nestedSort = [], add = function(a) {
    if (a.length && !Array.isArray(a[0])) {
      nestedSort.push(a);
    } else {
      $4.merge(nestedSort, a);
    }
  };
  if (Array.isArray(fixed)) {
    add(fixed);
...
function _fnSortListener2(settings, colIdx, append, callback) {
  ...
  if (append && settings.oFeatures.bSortMulti) {
    var sortIdx = $4.inArray(colIdx, _pluck2(sorting, "0"));
    if (sortIdx !== -1) {
      nextSortIdx = next(sorting[sortIdx], true);
      if (nextSortIdx === null && sorting.length === 1) {
        nextSortIdx = 0;
...
function _fnSortingClasses2(settings) {
  ...
  if (features.bSort && features.bSortClasses) {
    for (i2 = 0, ien = oldSort.length; i2 < ien; i2++) {
      colIdx = oldSort[i2].src;
      $4(_pluck2(settings.aoData, "anCells", colIdx)).removeClass(sortClass + (i2 < 2 ? i2 + 1 : 3));
    }
    for (i2 = 0, ien = sort.length; i2 < ien; i2++) {
      colIdx = sort[i2].src;
      $4(_pluck2(settings.aoData, "anCells", colIdx)).addClass(sortClass + (i2 < 2 ? i2 + 1 : 3));
    }
  }
  settings.aLastSort = sort;
}
function _fnSortData2(settings, idx) {
  ...
  for (var i2 = 0, ien = settings.aoData.length; i2 < ien; i2++) {
    ...
    if (!row._aSortData[idx] || customSort) {
      cellData = customSort ? customData[i2] : (
        // If there was a custom sort function, use data from there
        _fnGetCellData2(settings, i2, idx, "sort")
      );
      row._aSortData[idx] = formatter ? formatter(cellData) : cellData;
    }
  }
...
function _fnSaveState2(settings) {
  ...
  var state = {
    ...
    columns: $4.map(settings.aoColumns, function(col, i2) {
      return {
        visible: col.bVisible,
        search: _fnSearchToCamel2(settings.aoPreSearchCols[i2])
      };
    })
  };
  settings.oSavedState = state;
...
function _fnImplementState2(settings, s, callback) {
  ...
  settings.oLoadedState = $4.extend(true, {}, s);
  if (s.length !== void 0) {
    if (api) {
      api.page.len(s.length);
    } else {
  ...
  if (s.order !== void 0) {
    settings.aaSorting = [];
    $4.each(s.order, function(i3, col2) {
      settings.aaSorting.push(
        col2[0] >= columns.length ? [0, col2[1]] : col2
      );
    });
  ...
  if (s.search !== void 0) {
    $4.extend(settings.oPreviousSearch, _fnSearchToHung2(s.search));
  }
  if (s.columns) {
    for (i2 = 0, ien = s.columns.length; i2 < ien; i2++) {
      var col = s.columns[i2];
      ...
      if (col.search !== void 0) {
        $4.extend(settings.aoPreSearchCols[i2], _fnSearchToHung2(col.search));
      }
    }
    if (api) {
      api.columns.adjust();
...
function _fnSettingsFromNode2(table) {
  ...
  var idx = $4.inArray(table, _pluck2(settings, "nTable"));
  return idx !== -1 ? settings[idx] : null;
}
...
function _fnBindAction2(n, oData, fn) {
  $4(n).on("click.DT", oData, function(e) {
    $4(n).trigger("blur");
    fn(e);
  }).on("keypress.DT", oData, function(e) {
    if (e.which === 13) {
...
function _fnCallbackFire2(settings, callbackArr, eventName, args) {
  ...
  if (eventName !== null) {
    var e = $4.Event(eventName + ".dt");
    var table = $4(settings.nTable);
    table.trigger(e, args);
    if (table.parents("body").length === 0) {
      $4("body").trigger(e, args);
    }
    ret.push(e.result);
  }
  return ret;
...
$4.extend(_Api2.prototype, {
  ...
  iterator: function(flatten, type, fn, alwaysNew) {
    ...
    for (i2 = 0, ien = context.length; i2 < ien; i2++) {
      var apiInst = new _Api2(context[i2]);
      if (type === "table") {
        ret = fn.call(apiInst, context[i2], i2);
        if (ret !== void 0) {
          a.push(ret);
        ...
        items = this[i2];
        if (type === "column-rows") {
          rows = _selector_row_indexes2(context[i2], selector.opts);
        }
        for (j = 0, jen = items.length; j < jen; j++) {
          item = items[j];
          if (type === "cell") {
  ...
  // Does not return an API instance
  reduce: __arrayProto2.reduce || function(fn, init2) {
    return _fnReduce2(this, fn, init2, 0, this.length, 1);
  },
  reduceRight: __arrayProto2.reduceRight || function(fn, init2) {
    return _fnReduce2(this, fn, init2, this.length - 1, -1, -1);
  },
...
_Api2.register = _api_register2 = function(name, val) {
  ...
  var i2, ien, heir = name.split("."), struct = __apiStruct2, key, method;
  var find = function(src2, name2) {
    for (var i3 = 0, ien2 = src2.length; i3 < ien2; i3++) {
      if (src2[i3].name === name2) {
        return src2[i3];
...
var __table_selector2 = function(selector, a) {
  ...
  var nodes = $4.map(a, function(el, i2) {
    return el.nTable;
  });
...
var _selector_row_indexes2 = function(settings, opts) {
  ...
  if (_fnDataSource2(settings) == "ssp") {
    ...
    if (search == "none") {
      ...
      a = $4.map(displayMaster, function(el) {
        return !displayFilteredMap.hasOwnProperty(el) ? el : null;
      });
    }
  } else if (order == "index" || order == "original") {
...
$4(document).on("plugin-init.dt", function(e, context) {
...
var __details_add2 = function(ctx, row, data, klass) {
  var rows = [];
  var addRow = function(r, k) {
    if (Array.isArray(r) || r instanceof $4) {
      for (var i2 = 0, ien = r.length; i2 < ien; i2++) {
        addRow(r[i2], k);
      }
      return;
    ...
    if (r.nodeName && r.nodeName.toLowerCase() === "tr") {
      ...
      var created = $4("<tr><td></td></tr>").addClass(k);
      $4("td", created).addClass(k).html(r)[0].colSpan = _fnVisbleColumns2(ctx);
      rows.push(created[0]);
    }
  };
  addRow(data, klass);
...
var __column_selector2 = function(settings, selector, opts) {
  ...
  var run = function(s) {
    ...
    var jqResult = $4(nodes).filter(s).map(function() {
      return $4.inArray(this, nodes);
    }).toArray();
    if (jqResult.length || !s.nodeName) {
      return jqResult;
    }
    var host = $4(s).closest("*[data-dt-column]");
    return host.length ? [host.data("dt-column")] : [];
  };
...
var __setColumnVis2 = function(settings, column, vis) {
  ...
  if (vis) {
    var insertBefore = $4.inArray(true, _pluck2(cols, "bVisible"), column + 1);
    for (i2 = 0, ien = data.length; i2 < ien; i2++) {
      tr = data[i2].nTr;
      cells = data[i2].anCells;
      if (tr) {
    ...
    $4(_pluck2(settings.aoData, "anCells", column)).detach();
  }
  col.bVisible = vis;
};
...
_api_registerPlural2("columns().visible()", "column().visible()", function(vis, calc) {
  ...
  if (vis !== void 0) {
    this.iterator("table", function(settings) {
      ...
      _fnDrawHead2(settings, settings.aoFooter);
      if (!settings.aiDisplay.length) {
        $4(settings.nTBody).find("td[colspan]").attr("colspan", _fnVisbleColumns2(settings));
      }
...
var __cell_selector2 = function(settings, selector, opts) {
  ...
  var allCells = $4(_flatten2([], cells));
  var row;
  var columns = settings.aoColumns.length;
  var a, i2, ien, j, o, host;
  var run = function(s) {
    ...
    if ($4.isPlainObject(s)) {
      return s.column !== void 0 && s.row !== void 0 && $4.inArray(s.row, rows) !== -1 ? [s] : [];
    }
    var jqResult = allCells.filter(s).map(function(i3, el) {
      return {
        // use a new object, in case someone changes the values
...
_api_register2("search()", function(input, regex, smart, caseInsen) {
  ...
  return this.iterator("table", function(settings) {
    ...
    _fnFilterComplete2(settings, $4.extend({}, settings.oPreviousSearch, {
      "sSearch": input + "",
      "bRegex": regex === null ? false : regex,
      "bSmart": smart === null ? true : smart,
      "bCaseInsensitive": caseInsen === null ? true : caseInsen
...
DataTable2.isDataTable = DataTable2.fnIsDataTable = function(table) {
  ...
  $4.each(DataTable2.settings, function(i2, o) {
    var head = o.nScrollHead ? $4("table", o.nScrollHead)[0] : null;
    var foot = o.nScrollFoot ? $4("table", o.nScrollFoot)[0] : null;
    if (o.nTable === t || head === t || foot === t) {
      is = true;
    }
  });
...
DataTable2.tables = DataTable2.fnTables = function(visible) {
  ...
  var a = $4.map(DataTable2.settings, function(o) {
    if (!visible || visible && $4(o.nTable).is(":visible")) {
      return o.nTable;
    }
  });
...
$4.each(["on", "one", "off"], function(i2, key) {
  _api_register2(key + "()", function() {
    var args = Array.prototype.slice.call(arguments);
    args[0] = $4.map(args[0].split(/\s/), function(e) {
      return !e.match(/\.dt\b/) ? e + ".dt" : e;
    }).join(" ");
...
_api_register2("destroy()", function(remove) {
  ...
  return this.iterator("table", function(settings) {
    ...
    var rows = $4.map(settings.aoData, function(r) {
      return r.nTr;
    });
    var i2, ien;
    settings.bDestroying = true;
    ...
    var idx = $4.inArray(settings, DataTable2.settings);
    if (idx !== -1) {
...
DataTable2.defaults = {
   ...
   *    } )
   */
  "oSearch": $4.extend({}, DataTable2.models.oSearch),
  /**
   * __Deprecated__ The functionality provided by this parameter has now been
   * superseded by that provided through `ajax`, which should be used instead.
   *
...
$4.extend(DataTable2.ext.classes, {
  "sTable": "dataTable",
  "sNoFooter": "no-footer",
  /* Paging buttons */
  "sPageButton": "paginate_button",
...
function _numbers2(page, pages) {
  var numbers = [], buttons = extPagination2.numbers_length, half = Math.floor(buttons / 2), i2 = 1;
  if (pages <= buttons) {
...
$4.extend(true, DataTable2.ext.renderer, {
  pageButton: {
    _: function(settings, host, idx, buttons, page, pages) {
      var classes = settings.oClasses;
      var lang = settings.oLanguage.oPaginate;
...
$4.extend(DataTable2.ext.type.detect, [
  // Plain numbers - first since V8 detects some plain numbers as dates
  // e.g. Date.parse('55') (but not all, e.g. Date.parse('22')...).
  function(d, settings) {
    var decimal = settings.oLanguage.sDecimal;
...
$4.extend(DataTable2.ext.type.search, {
  html: function(data) {
...
$4.extend(true, DataTable2.ext.renderer, {
  header: {
    _: function(settings, cell, column, classes) {
      $4(settings.nTable).on("order.dt.DT", function(e, ctx, sorting, columns) {
        if (settings !== ctx) {
          return;
        }
        var colIdx = column.idx;
...
if (window.Intl !== void 0) {
  try {
    ...
    for (i2 = 0; i2 < num.length; i2++) {
      if (num[i2].type === "group") {
        __thousands2 = num[i2].value;
      } else if (num[i2].type === "decimal") {
        __decimal2 = num[i2].value;
      }
    }
  } catch (e) {
  }
...
$4.extend(DataTable2.ext.internal, {
...
$4.fn.dataTable = DataTable2;
DataTable2.$ = $4;
$4.fn.dataTableSettings = DataTable2.settings;
$4.fn.dataTableExt = DataTable2.ext;
$4.fn.DataTable = function(opts) {
  return $4(this).dataTable(opts).api();
};
$4.each(DataTable2, function(prop, val) {
...
var _dtButtons = jquery_dataTables_default2.ext.buttons;
...
var Buttons = function(dt, config) {
  ...
  this.c = $5.extend(true, {}, Buttons.defaults, config);
  if (config.buttons) {
    this.c.buttons = config.buttons;
  }
  this.s = {
    dt: new jquery_dataTables_default2.Api(dt),
    buttons: [],
    listenKeys: "",
    namespace: "dtb" + _instCounter++
  };
  this.dom = {
    container: $5("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className)
  };
  this._constructor();
};
$5.extend(Buttons.prototype, {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * Public methods
   */
  /**
  ...
  */
  ...
  disable: function(node) {
    var button = this._nodeToButton(node);
    $5(button.node).addClass(this.c.dom.button.disabled).prop("disabled", true);
    return this;
  },
  /**
   ...
   */
  destroy: function() {
    $5("body").off("keyup." + this.s.namespace);
  ...
  enable: function(node, flag) {
    ...
    var button = this._nodeToButton(node);
    $5(button.node).removeClass(this.c.dom.button.disabled).prop("disabled", false);
    return this;
  },
  /**
  ...
  processing: function(node, flag) {
    ...
    var button = this._nodeToButton(node);
    if (flag === void 0) {
      return $5(button.node).hasClass("processing");
    }
    $5(button.node).toggleClass("processing", flag);
    $5(dt.table().node()).triggerHandler("buttons-processing.dt", [
      flag,
      dt.button(node),
      dt,
      $5(node),
  ...
  remove: function(node) {
    ...
    if (button.conf.destroy) {
      button.conf.destroy.call(dt.button(node), dt, $5(node), button.conf);
    }
    this._removeKey(button.conf);
    $5(button.node).remove();
    var idx = $5.inArray(button, host);
    host.splice(idx, 1);
    return this;
  },
  /**
  ...
  */
  ...
  _constructor: function() {
    ...
    $5("body").on("keyup." + this.s.namespace, function(e) {
  ...
  _addKey: function(conf) {
    if (conf.key) {
      this.s.listenKeys += $5.isPlainObject(conf.key) ? conf.key.key : conf.key;
    }
  },
  /**
  ...
  _expandButton: function(attachTo, button, split, inCollection, inSplit, attachPoint, parentConf) {
    ...
    for (var i2 = 0, ien = buttons.length; i2 < ien; i2++) {
      ...
      if (built.conf.buttons) {
        built.collection = $5("<" + domCollection.container.content.tag + "/>");
        built.conf._collection = built.collection;
        $5(built.node).append(domCollection.action.dropHtml);
        this._expandButton(
          built.buttons,
          built.conf.buttons,
          built.conf.split,
      ...
      if (built.conf.split) {
        built.collection = $5("<" + domCollection.container.tag + "/>");
        built.conf._collection = built.collection;
      ...
      if (conf.init) {
        conf.init.call(dt.button(built.node), dt, $5(built.node), conf);
      }
    }
  },
  /**
  ...
  _buildButton: function(config, inCollection, isSplit, inSplit) {
    ...
    var dom = $5.extend(true, {}, configDom.button);
    if (inCollection && isSplit && configDom.collection.split) {
      $5.extend(true, dom, configDom.collection.split.action);
    } else if (inSplit || inCollection) {
      $5.extend(true, dom, configDom.collection.button);
    } else if (isSplit) {
      $5.extend(true, dom, configDom.split.button);
    }
    if (config.spacer) {
      var spacer = $5("<" + dom.spacer.tag + "/>").addClass("dt-button-spacer " + config.style + " " + dom.spacer.className).html(text(config.text));
      return {
        conf: config,
        node: spacer,
        inserter: spacer,
    ...
    if (!config.hasOwnProperty("html")) {
      var action = function(e, dt2, button2, config2) {
        ...
        $5(dt2.table().node()).triggerHandler("buttons-action.dt", [
          dt2.button(button2),
          dt2,
          button2,
          config2
      ...
      button = $5("<" + tag + "/>").addClass(dom.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(e) {
        e.preventDefault();
      ...
      if (dom.liner.tag) {
        var liner = $5("<" + dom.liner.tag + "/>").html(text(config.text)).addClass(dom.liner.className);
      ...
      button = $5(config.html);
    }
    var buttonContainer = this.c.dom.buttonContainer;
    var inserter;
    if (buttonContainer && buttonContainer.tag) {
      inserter = $5("<" + buttonContainer.tag + "/>").addClass(buttonContainer.className).append(button);
    } else {
      inserter = button;
    }
    this._addKey(config);
    ...
    var splitDiv;
    if (isSplit) {
      var dropdownConf = inCollection ? $5.extend(true, this.c.dom.split, this.c.dom.collection.split) : this.c.dom.split;
      var wrapperConf = dropdownConf.wrapper;
      splitDiv = $5("<" + wrapperConf.tag + "/>").addClass(wrapperConf.className).append(button);
      var dropButtonConfig = $5.extend(config, {
  ...
  _keypress: function(character, e) {
    ...
    var run = function(conf, node) {
      ...
      if (conf.key === character) {
        ...
        $5(node).click();
      } else if ($5.isPlainObject(conf.key)) {
  ...
  _removeKey: function(conf) {
    if (conf.key) {
      var character = $5.isPlainObject(conf.key) ? conf.key.key : conf.key;
      var a = this.s.listenKeys.split("");
      var idx = $5.inArray(character, a);
      a.splice(idx, 1);
  ...
  _resolveExtends: function(conf) {
    ...
    var toConfObject = function(base) {
      var loop = 0;
      while (!$5.isPlainObject(base) && !Array.isArray(base)) {
        if (base === void 0) {
          return;
        }
      ...
      return Array.isArray(base) ? base : $5.extend({}, base);
    };
    ...
    while (conf && conf.extend) {
      ...
      if (conf.config !== void 0 && objArray.config !== void 0) {
        conf.config = $5.extend({}, objArray.config, conf.config);
      }
      conf = $5.extend({}, objArray, conf);
  ...
  _popover: function(content, hostButton, inOpts, e) {
    ...
    var close = function() {
      closed = true;
      _fadeOut($5(containerSelector), options.fade, function() {
        $5(this).detach();
      });
      $5(dt.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()).attr(
        "aria-expanded",
        "false"
      );
      $5("div.dt-button-background").off("click.dtb-collection");
      Buttons.background(false, options.backgroundClassName, options.fade, hostNode);
      $5(window).off("resize.resize.dtb-collection");
      $5("body").off(".dtb-collection");
    ...
    var cnt = $5(".dt-button", content).length;
    var mod = "";
    if (cnt === 3) {
      mod = "dtb-b3";
    } else if (cnt === 2) {
    ...
    var display = $5("<" + options.tag + "/>").addClass(options.containerClassName).addClass(options.collectionLayout).addClass(options.splitAlignClass).addClass(mod).css("display", "none").attr({
      "aria-modal": true,
      role: "dialog"
    });
    content = $5(content).addClass(options.contentClassName).attr("role", "menu").appendTo(display);
    ...
    var tableContainer = $5(hostButton.table().container());
    ...
    if (position === "absolute") {
      var offsetParent = $5(hostNode[0].offsetParent);
      ...
      if (containerPosition.left + left + popoverSizes.width > $5(window).width()) {
        left = $5(window).width() - popoverSizes.width - containerPosition.left;
      }
      if (buttonOffset.left + left < 0) {
        left = -buttonOffset.left;
      }
      if (containerPosition.top + top + popoverSizes.height > $5(window).height() + $5(window).scrollTop()) {
        top = buttonPosition.top - popoverSizes.height - popoverSizes.marginTop - popoverSizes.marginBottom;
      }
      if (containerPosition.top + top < $5(window).scrollTop()) {
      ...
      position();
      $5(window).on("resize.dtb-collection", function() {
        position();
      });
    }
    ...
    $5("div.dt-button-background").on("click.dtb-collection", function() {
    });
    ...
    $5(display).trigger("buttons-popover.dt");
    dt.on("destroy", close);
    setTimeout(function() {
      closed = false;
      $5("body").on("click.dtb-collection", function(e2) {
        if (closed) {
          return;
        }
        var back = $5.fn.addBack ? "addBack" : "andSelf";
        var parent = $5(e2.target).parent()[0];
        if (!$5(e2.target).parents()[back]().filter(content).length && !$5(parent).hasClass("dt-buttons") || $5(e2.target).hasClass("dt-button-background")) {
          close();
        }
        ...
        var elements = $5("a, button", content);
...
Buttons.background = function(show, className, fade, insertPoint) {
  ...
  if (show) {
    _fadeIn(
      $5("<div/>").addClass(className).css("display", "none").insertAfter(insertPoint),
      fade
    );
  } else {
    _fadeOut($5("div." + className), fade, function() {
      $5(this).removeClass(className).remove();
    });
  }
};
Buttons.instanceSelector = function(group, buttons) {
  if (group === void 0 || group === null) {
    return $5.map(buttons, function(v) {
      return v.inst;
    });
  }
  var ret = [];
  var names = $5.map(buttons, function(v) {
    return v.name;
  });
  var process = function(input) {
    ...
    if (typeof input === "string") {
      if (input.indexOf(",") !== -1) {
        ...
        var idx = $5.inArray(input.trim(), names);
        if (idx !== -1) {
...
Buttons.buttonSelector = function(insts, selector) {
  ...
  var run = function(selector2, inst2) {
    ...
    var nodes = $5.map(buttons, function(v) {
      return v.node;
    });
    if (Array.isArray(selector2) || selector2 instanceof $5) {
    ...
    if (selector2 === null || selector2 === void 0 || selector2 === "*") {
      ...
      if (selector2.indexOf(",") !== -1) {
        ...
        var indexes = $5.map(buttons, function(v) {
          return v.idx;
        });
        ret.push({
          inst: inst2,
          node: buttons[$5.inArray(selector2, indexes)].node
        });
        ...
        $5(nodes).filter(selector2).each(function() {
          ret.push({
            inst: inst2,
            node: this
          });
      ...
      var idx = $5.inArray(selector2, nodes);
      if (idx !== -1) {
        ret.push({
          inst: inst2,
          node: nodes[idx]
...
$5.extend(_dtButtons, {
  collection: {
    ...
    action: function(e, dt, button, config) {
      ...
      if (e.type === "keypress") {
        $5("a, button", config._collection).eq(0).focus();
      }
    },
    attr: {
      "aria-haspopup": "dialog"
  ...
  pageLength: function(dt) {
    ...
    return {
      ...
      autoClose: true,
      buttons: $5.map(vals, function(val, i3) {
        return {
          text: lang[i3],
...
jquery_dataTables_default2.Api.register("buttons()", function(group, selector) {
  if (selector === void 0) {
    selector = group;
    group = void 0;
  }
...
jquery_dataTables_default2.Api.register("button()", function(group, selector) {
...
jquery_dataTables_default2.Api.registerPlural("buttons().active()", "button().active()", function(flag) {
  if (flag === void 0) {
...
jquery_dataTables_default2.Api.registerPlural("buttons().action()", "button().action()", function(action) {
  if (action === void 0) {
    return this.map(function(set) {
...
jquery_dataTables_default2.Api.registerPlural(
...
jquery_dataTables_default2.Api.register(["buttons().enable()", "button().enable()"], function(flag) {
  return this.each(function(set) {
    set.inst.enable(set.node, flag);
  });
});
jquery_dataTables_default2.Api.register(["buttons().disable()", "button().disable()"], function() {
  return this.each(function(set) {
    set.inst.disable(set.node);
  });
});
jquery_dataTables_default2.Api.register("button().index()", function() {
  var idx = null;
...
jquery_dataTables_default2.Api.registerPlural("buttons().nodes()", "button().node()", function() {
  var jq = $5();
  $5(
    this.each(function(set) {
...
jquery_dataTables_default2.Api.registerPlural("buttons().processing()", "button().processing()", function(flag) {
  if (flag === void 0) {
    return this.map(function(set) {
...
jquery_dataTables_default2.Api.registerPlural("buttons().text()", "button().text()", function(label) {
  if (label === void 0) {
    return this.map(function(set) {
...
jquery_dataTables_default2.Api.registerPlural("buttons().trigger()", "button().trigger()", function() {
  return this.each(function(set) {
    set.inst.node(set.node).trigger("click");
  });
});
jquery_dataTables_default2.Api.register("button().popover()", function(content, options) {
  return this.map(function(set) {
    return set.inst._popover(content, this.button(this[0].node), options);
  });
});
jquery_dataTables_default2.Api.register("buttons().containers()", function() {
  var jq = $5();
...
jquery_dataTables_default2.Api.register("buttons().container()", function() {
  return this.containers().eq(0);
});
jquery_dataTables_default2.Api.register("button().add()", function(idx, conf, draw) {
  var ctx = this.context;
  if (ctx.length) {
...
jquery_dataTables_default2.Api.register("buttons().destroy()", function() {
  this.pluck("inst").unique().each(function(inst) {
    inst.destroy();
  });
  return this;
});
jquery_dataTables_default2.Api.registerPlural("buttons().remove()", "buttons().remove()", function() {
  this.each(function(set) {
...
var _infoTimer;
jquery_dataTables_default2.Api.register("buttons.info()", function(title, message, time) {
  var that = this;
  if (title === false) {
    this.off("destroy.btn-info");
    _fadeOut($5("#datatables_buttons_info"), 400, function() {
      $5(this).remove();
    });
  ...
  if ($5("#datatables_buttons_info").length) {
    $5("#datatables_buttons_info").remove();
  }
  title = title ? "<h2>" + title + "</h2>" : "";
  _fadeIn(
    $5('<div id="datatables_buttons_info" class="dt-button-info"/>').html(title).append($5("<div/>")[typeof message === "string" ? "html" : "append"](message)).css("display", "none").appendTo("body")
  );
...
jquery_dataTables_default2.Api.register("buttons.exportData()", function(options) {
  if (this.context.length) {
    return _exportData(new jquery_dataTables_default2.Api(this.context[0]), options);
  }
});
jquery_dataTables_default2.Api.register("buttons.exportInfo()", function(conf) {
  if (!conf) {
    conf = {};
  }
  return {
...
var _filename = function(config) {
  ...
  if (filename.indexOf("*") !== -1) {
    filename = filename.replace("*", $5("head > title").text()).trim();
  }
...
var _title = function(config) {
  ...
  return title === null ? null : title.indexOf("*") !== -1 ? title.replace("*", $5("head > title").text() || "Exported data") : title;
};
var _message = function(dt, option, position) {
  ...
  var caption = $5("caption", dt.table().container()).eq(0);
  if (message === "*") {
...
var _exportTextarea = $5("<textarea/>")[0];
var _exportData = function(dt, inOpts) {
  ...
  var modifier = $5.extend({}, config.modifier);
  if (dt.select && typeof dt.select.info === "function" && modifier.selected === void 0) {
    if (dt.rows(config.rows, $5.extend({ selected: true }, modifier)).any()) {
      $5.extend(modifier, { selected: true });
    }
  }
...
$5.fn.dataTable.Buttons = Buttons;
$5.fn.DataTable.Buttons = Buttons;
$5(document).on("init.dt plugin-init.dt", function(e, settings) {
  if (e.namespace !== "dt") {
    return;
  }
  var opts = settings.oInit.buttons || jquery_dataTables_default2.defaults.buttons;
  if (opts && !settings._buttons) {
    new Buttons(settings, opts).container();
  }
});
function _init(settings, options) {
  var api = new jquery_dataTables_default2.Api(settings);
  var opts = options ? options : api.init().buttons || jquery_dataTables_default2.defaults.buttons;
  return new Buttons(api, opts).container();
}
jquery_dataTables_default2.ext.feature.push({
  fnInit: _init,
  cFeature: "B"
});
if (jquery_dataTables_default2.ext.features) {
  jquery_dataTables_default2.ext.features.register("buttons", _init);
}

// node_modules/datatables.net-buttons-bs5/js/buttons.bootstrap5.mjs
var $6 = import_jquery5.default;
$6.extend(true, dataTables_bootstrap5_default.Buttons.defaults, {
  dom: {
    container: {
...
var $7 = import_jquery6.default;
jquery_dataTables_default2.select = {};
jquery_dataTables_default2.select.version = "1.7.0";
jquery_dataTables_default2.select.init = function(dt) {
  ...
  var defaults = jquery_dataTables_default2.defaults.select;
  ...
  $7.fn.dataTable.ext.order["select-checkbox"] = function(settings, col) {
    return this.api().column(col, { order: "index" }).nodes().map(function(td) {
      if (settings._select.items === "row") {
        return $7(td).parent().hasClass(settings._select.className);
      } else if (settings._select.items === "cell") {
        return $7(td).hasClass(settings._select.className);
      }
      return false;
    });
  };
...
function enableMouseSelection(dt) {
  ...
  container.on("mousedown.dtSelect", selector, function(e) {
    ...
    if ($7(e.target).closest("div." + wrapperClass)[0] != dt.table().container()) {
      return;
    }
...
function info(api) {
  ...
  $7.each(ctx.aanFeatures.i, function(i2, el) {
    el = $7(el);
...
function init(ctx) {
  var api = new jquery_dataTables_default2.Api(ctx);
...
function rowColumnRange(dt, type, idx, last) {
  ...
  var idx1 = $7.inArray(last, indexes);
  var idx2 = $7.inArray(idx, indexes);
  if (!dt[type + "s"]({ selected: true }).any() && idx1 === -1) {
    indexes.splice($7.inArray(idx, indexes) + 1, indexes.length);
  } else {
    if (idx1 > idx2) {
      var tmp = idx2;
      idx2 = idx1;
  ...
  if (!dt[type](idx, { selected: true }).any()) {
    ...
    indexes.splice($7.inArray(idx, indexes), 1);
...
$7.each(
  ...
  function(i2, o) {
    jquery_dataTables_default2.ext.selector[o.type].push(function(settings, opts, indexes) {
...
jquery_dataTables_default2.ext.selector.cell.push(function(settings, opts, cells) {
  var selected = opts.selected;
  var rowData;
  var out = [];
  if (selected === void 0) {
...
var apiRegister = jquery_dataTables_default2.Api.register;
var apiRegisterPlural = jquery_dataTables_default2.Api.registerPlural;
apiRegister("select()", function() {
  return this.iterator("table", function(ctx) {
    jquery_dataTables_default2.select.init(new jquery_dataTables_default2.Api(ctx));
  });
});
...
apiRegister("select.items()", function(items) {
  ...
  return this.iterator("table", function(ctx) {
    ...
    eventTrigger(new jquery_dataTables_default2.Api(ctx), "selectItems", [items]);
  });
});
apiRegister("select.style()", function(style) {
  ...
  return this.iterator("table", function(ctx) {
    ...
    var dt = new jquery_dataTables_default2.Api(ctx);
    disableMouseSelection(dt);
    if (style !== "api") {
      enableMouseSelection(dt);
    }
    eventTrigger(new jquery_dataTables_default2.Api(ctx), "selectStyle", [style]);
  });
});
apiRegister("select.selector()", function(selector) {
  ...
  return this.iterator("table", function(ctx) {
    disableMouseSelection(new jquery_dataTables_default2.Api(ctx));
    ctx._select.selector = selector;
    if (ctx._select.style !== "api") {
      enableMouseSelection(new jquery_dataTables_default2.Api(ctx));
    }
  });
});
apiRegisterPlural("rows().select()", "row().select()", function(select) {
  ...
  this.iterator("row", function(ctx, idx) {
    ...
    $7(ctx.aoData[idx].nTr).addClass(ctx._select.className);
  });
...
apiRegisterPlural("columns().select()", "column().select()", function(select) {
  ...
  this.iterator("column", function(ctx, idx) {
    ...
    var column = new jquery_dataTables_default2.Api(ctx).column(idx);
...
apiRegisterPlural("rows().deselect()", "row().deselect()", function() {
  ...
  this.iterator("row", function(ctx, idx) {
    ...
    $7(ctx.aoData[idx].nTr).removeClass(ctx._select.className);
  });
  this.iterator("table", function(ctx, i2) {
...
apiRegisterPlural("columns().deselect()", "column().deselect()", function() {
  ...
  this.iterator("column", function(ctx, idx) {
    ...
    var api2 = new jquery_dataTables_default2.Api(ctx);
...
function enabled(dt, config) {
  if ($7.inArray("rows", config.limitTo) !== -1 && dt.rows({ selected: true }).any()) {
    return true;
  }
  if ($7.inArray("columns", config.limitTo) !== -1 && dt.columns({ selected: true }).any()) {
    return true;
  }
  if ($7.inArray("cells", config.limitTo) !== -1 && dt.cells({ selected: true }).any()) {
    return true;
  }
  return false;
}
var _buttonNamespace = 0;
$7.extend(jquery_dataTables_default2.ext.buttons, {
  selected: {
  ...
  showSelected: {
    ...
    action: function(e, dt, node, conf) {
      if (conf._filter) {
        var idx = jquery_dataTables_default2.ext.search.indexOf(conf._filter);
        if (idx !== -1) {
          jquery_dataTables_default2.ext.search.splice(idx, 1);
          conf._filter = null;
        }
        this.active(false);
      } else {
        ...
        conf._filter = fn;
        jquery_dataTables_default2.ext.search.push(fn);
        this.active(true);
      }
      dt.draw();
    }
...
$7.each(["Row", "Column", "Cell"], function(i2, item) {
  var lc = item.toLowerCase();
  jquery_dataTables_default2.ext.buttons["select" + item + "s"] = {
...
$7.fn.DataTable.select = jquery_dataTables_default2.select;
$7(document).on("preInit.dt.dtSelect", function(e, ctx) {
  if (e.namespace !== "dt") {
    return;
  }
  jquery_dataTables_default2.select.init(new jquery_dataTables_default2.Api(ctx));
...
// node_modules/laravel-datatables-vite/js/index.js
window.jQuery = window.$ = import_jquery8.default;
window.bootstrap = bootstrap_esm_exports;
window.DataTable = dataTables_bootstrap5_default;
import_jquery8.default.extend(true, dataTables_bootstrap5_default.defaults, {
...
import_jquery8.default.extend(true, dataTables_bootstrap5_default.Buttons.defaults, {
  dom: {
    buttonLiner: {
      tag: ""
    }
...
import_jquery8.default.extend(dataTables_bootstrap5_default.ext.classes, {
